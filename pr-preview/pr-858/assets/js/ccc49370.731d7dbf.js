(self["webpackChunkpush_website"] = self["webpackChunkpush_website"] || []).push([[83249],{
...
// EXTERNAL MODULE: ./src/theme/BlogPostItem/index.js + 2 modules
var BlogPostItem = __webpack_require__(282774);
// EXTERNAL MODULE: ./node_modules/react/index.js
var react = __webpack_require__(296540);
// EXTERNAL MODULE: ./node_modules/react/jsx-runtime.js
var jsx_runtime = __webpack_require__(474848);
;// CONCATENATED MODULE: ./src/theme/BlogPostPage/Metadata/index.js
/**
 * Copyright (c) Facebook, Inc. and its affiliates.
 *
 * This source code is licensed under the MIT license found in the
...
// EXTERNAL MODULE: ./node_modules/@docusaurus/core/lib/client/exports/Translate.js + 1 modules
var exports_Translate = __webpack_require__(721312);
// EXTERNAL MODULE: ./src/theme/PaginatorNavLink/index.js
var theme_PaginatorNavLink = __webpack_require__(880222);
// EXTERNAL MODULE: ./node_modules/styled-components/dist/styled-components.browser.esm.js + 9 modules
var styled_components_browser_esm = __webpack_require__(944404);
;// CONCATENATED MODULE: ./src/theme/BlogPostPaginator/index.js
/**
 * Copyright (c) Facebook, Inc. and its affiliates.
 *
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */function BlogPostPaginator(props){const{nextItem,prevItem}=props;return/*#__PURE__*/_jsxs(Nav,{className:"pagination-nav docusaurus-mt-lg","aria-label":translate({id:'theme.blog.post.paginator.navAriaLabel',message:'Blog post page navigation',description:'The ARIA label for the blog posts pagination'}),children:[prevItem&&/*#__PURE__*/_jsx(PaginatorNavLink,{...prevItem,subLabel:/*#__PURE__*/_jsx(Translate,{id:"theme.blog.post.paginator.newerPost",description:"The blog post button label to navigate to the newer/previous post",children:"Newer Post"})}),nextItem&&/*#__PURE__*/_jsx(PaginatorNavLink,{...nextItem,subLabel:/*#__PURE__*/_jsx(Translate,{id:"theme.blog.post.paginator.olderPost",description:"The blog post button label to navigate to the older/next post",children:"Older Post"}),isNext:true})]});}const Nav=styled_components_browser_esm/* default */.Ay.nav.withConfig({displayName:"BlogPostPaginator__Nav",componentId:"sc-uf75qw-0"})([""]);
...
;// CONCATENATED MODULE: ./src/theme/BlogPostPage/MorePosts.js
// Internal Components
// Internal Configs
const MorePosts=_ref=>{let{allPosts,post}=_ref;const isMobile=(0,useMediaQuery/* default */.A)(globals/* device */.jO.tablet);const[filteredArray,setFilteredArray]=(0,react.useState)();const filterPost=()=>{var _post$Preview;const tagList=post===null||post===void 0||(_post$Preview=post.Preview)===null||_post$Preview===void 0||(_post$Preview=_post$Preview.metadata)===null||_post$Preview===void 0?void 0:_post$Preview.tags;const allOtherPosts=allPosts.filter(item=>item!==post);const sortArray=tagList===null||tagList===void 0?void 0:tagList.map(item=>{const matchingTags=allOtherPosts===null||allOtherPosts===void 0?void 0:allOtherPosts.filter(obj=>{var _obj$Preview;return obj===null||obj===void 0||(_obj$Preview=obj.Preview)===null||_obj$Preview===void 0||(_obj$Preview=_obj$Preview.metadata)===null||_obj$Preview===void 0||(_obj$Preview=_obj$Preview.tags)===null||_obj$Preview===void 0?void 0:_obj$Preview.some(tag=>(tag===null||tag===void 0?void 0:tag.label)===(item===null||item===void 0?void 0:item.label));});if(matchingTags&&matchingTags.length>0){// Randomly select one from matchingTags
const randomIndex=Math.floor(Math.random()*matchingTags.length);return matchingTags[randomIndex];}return null;});setFilteredArray(sortArray);};(0,react.useEffect)(()=>{filterPost();},[allPosts,post]);return/*#__PURE__*/(0,jsx_runtime.jsxs)("div",{children:[/*#__PURE__*/(0,jsx_runtime.jsxs)(MoreRow,{children:[/*#__PURE__*/(0,jsx_runtime.jsx)(ResponsiveH2,{size:isMobile?'16px':'24px',weight:"500",spacing:"-0.02em",lineHeight:"110%",color:"#00000",children:"More from Push Protocol"}),/*#__PURE__*/(0,jsx_runtime.jsxs)(MoreButton,{title:"Developer Docs",background:"#D53A94",radius:"12px",padding:"14px 20px",size:"16px",weight:"500",spacing:"-0.03em",lineHeight:"26px",display:"flex",flexDirection:"row",alignItems:"center",self:isMobile?'stretch':'self',onClick:()=>{window.open(`https://twitter.com/pushprotocol`,'_blank');},children:[/*#__PURE__*/(0,jsx_runtime.jsx)(index_esm/* BsTwitter */.Pj_,{size:23,color:"#fff",style:{marginRight:'10px'}}),"Follow"]})]}),/*#__PURE__*/(0,jsx_runtime.jsx)(GridItem,{marginTop:false,children:filteredArray===null||filteredArray===void 0?void 0:filteredArray.slice(0,4).map(item=>{var _item$Preview,_item$Preview2,_item$Preview3,_item$Preview4,_item$Preview5,_item$Preview6;return/*#__PURE__*/(0,jsx_runtime.jsx)(jsx_runtime.Fragment,{children:item!==null&&/*#__PURE__*/(0,jsx_runtime.jsxs)("div",{children:[/*#__PURE__*/(0,jsx_runtime.jsx)(SharedStyling/* Image */._V,{src:item===null||item===void 0||(_item$Preview=item.Preview)===null||_item$Preview===void 0||(_item$Preview=_item$Preview.assets)===null||_item$Preview===void 0?void 0:_item$Preview.image}),/*#__PURE__*/(0,jsx_runtime.jsxs)(TextView,{children:[/*#__PURE__*/(0,jsx_runtime.jsx)(Info/* default */.A,{morePosts:item===null||item===void 0||(_item$Preview2=item.Preview)===null||_item$Preview2===void 0?void 0:_item$Preview2.metadata}),/*#__PURE__*/(0,jsx_runtime.jsx)(Link/* default */.A,{itemProp:"url",to:item===null||item===void 0||(_item$Preview3=item.Preview)===null||_item$Preview3===void 0||(_item$Preview3=_item$Preview3.metadata)===null||_item$Preview3===void 0?void 0:_item$Preview3.permalink,children:/*#__PURE__*/(0,jsx_runtime.jsx)(LinkText,{children:item===null||item===void 0||(_item$Preview4=item.Preview)===null||_item$Preview4===void 0||(_item$Preview4=_item$Preview4.frontMatter)===null||_item$Preview4===void 0?void 0:_item$Preview4.title})}),/*#__PURE__*/(0,jsx_runtime.jsx)(TextSpan,{children:item===null||item===void 0||(_item$Preview5=item.Preview)===null||_item$Preview5===void 0||(_item$Preview5=_item$Preview5.frontMatter)===null||_item$Preview5===void 0?void 0:_item$Preview5.text})]}),/*#__PURE__*/(0,jsx_runtime.jsx)(Link/* default */.A,{to:item===null||item===void 0||(_item$Preview6=item.Preview)===null||_item$Preview6===void 0||(_item$Preview6=_item$Preview6.metadata)===null||_item$Preview6===void 0?void 0:_item$Preview6.permalink,style:{color:'#dd44b9'},children:"Read More"})]})});})})]});};const ResponsiveH2=(0,styled_components_browser_esm/* default */.Ay)(SharedStyling.H2).withConfig({displayName:"MorePosts__ResponsiveH2",componentId:"sc-19ujzwy-0"})([""]);const MoreRow=styled_components_browser_esm/* default */.Ay.div.withConfig({displayName:"MorePosts__MoreRow",componentId:"sc-19ujzwy-1"})(["margin:50px 0 0px 0;display:flex;justify-content:space-between;align-items:center;@media ","{flex-direction:row;margin-top:52px;align-items:center;}@media ","{display:flex;flex-direction:column;justify-content:space-between;align-items:center;}"],globals/* device */.jO.tablet,globals/* device */.jO.mobileL);const MoreButton=(0,styled_components_browser_esm/* default */.Ay)(SharedStyling/* Button */.$n).withConfig({displayName:"MorePosts__MoreButton",componentId:"sc-19ujzwy-2"})(["@media ","{width:100%;margin:20px;}"],globals/* device */.jO.mobileL);const GridItem=styled_components_browser_esm/* default */.Ay.div.withConfig({displayName:"MorePosts__GridItem",componentId:"sc-19ujzwy-3"})(["width:800px !important;display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:33px;box-sizing:border-box;margin:",";@media (max-width:820px){width:100% !important;padding:",";box-sizing:border-box;margin:10px auto 0 auto;gap:30px;}@media ","{grid-template-columns:repeat(1,minmax(0,1fr));}"],props=>props.marginTop?'100px auto 0 auto':'30px auto 100px auto',`${globals/* default */.Ay.STRUCTURE.PADDING.MOBILE}`,globals/* device */.jO.tablet);const TextView=styled_components_browser_esm/* default */.Ay.div.withConfig({displayName:"MorePosts__TextView",componentId:"sc-19ujzwy-4"})(["margin-top:20px;@media (max-width:1200px){width:100%;}"]);const TextSpan=styled_components_browser_esm/* default */.Ay.div.withConfig({displayName:"MorePosts__TextSpan",componentId:"sc-19ujzwy-5"})(["color:var(--ifm-color-secondary-blog);font-family:Strawford;font-size:19px;font-style:normal;font-weight:300;line-height:32px;margin-bottom:20px;overflow:hidden;display:-webkit-box !important;-webkit-line-clamp:3;-webkit-box-orient:vertical;"]);const LinkText=styled_components_browser_esm/* default */.Ay.div.withConfig({displayName:"MorePosts__LinkText",componentId:"sc-19ujzwy-6"})(["overflow:hidden;display:-webkit-box;-webkit-line-clamp:2;-webkit-box-orient:vertical;color:var(--ifm-color-primary-blog) !important;font-family:Strawford;font-size:22px;font-style:normal;font-weight:700;line-height:36px;&:hover{color:#dd44b9 !important;}"]);/* harmony default export */ const BlogPostPage_MorePosts = (MorePosts);
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */function BlogPostPageContent(_ref){let{allPosts,post,children}=_ref;const{metadata,toc}=(0,blogPost/* useBlogPost */.e)();const{nextItem,prevItem,frontMatter,unlisted}=metadata;const{hide_table_of_contents:hideTableOfContents,toc_min_heading_level:tocMinHeadingLevel,toc_max_heading_level:tocMaxHeadingLevel}=frontMatter;return/*#__PURE__*/(0,jsx_runtime.jsx)(BlogLayout/* default */.A,{toc:!hideTableOfContents&&toc.length>0?/*#__PURE__*/(0,jsx_runtime.jsx)(TOC/* default */.A,{toc:toc,minHeadingLevel:tocMinHeadingLevel,maxHeadingLevel:tocMaxHeadingLevel}):undefined,children:/*#__PURE__*/(0,jsx_runtime.jsxs)(BlogItem,{children:[/*#__PURE__*/(0,jsx_runtime.jsx)(BlogPostItem/* default */.A,{children:children}),/*#__PURE__*/(0,jsx_runtime.jsx)(FooterItem/* default */.A,{}),/*#__PURE__*/(0,jsx_runtime.jsx)(BlogPostPage_MorePosts,{allPosts:allPosts,post:post})]})});}function BlogPostPage(props){const blogPath=props.location.pathname.substring(0,props.location.pathname.length-1);const allPosts=props.allPosts;const contentName=allPosts===null||allPosts===void 0?void 0:allPosts.filter(x=>{var _x$Preview;return x===null||x===void 0||(_x$Preview=x.Preview)===null||_x$Preview===void 0||(_x$Preview=_x$Preview.metadata)===null||_x$Preview===void 0?void 0:_x$Preview.permalink.includes(blogPath);})[0];const BlogPostContent=contentName===null||contentName===void 0?void 0:contentName.Preview;// const BlogPostContent = props.content;
return/*#__PURE__*/(0,jsx_runtime.jsx)(blogPost/* BlogPostProvider */.i,{content:contentName===null||contentName===void 0?void 0:contentName.Preview,isBlogPostPage:true,children:/*#__PURE__*/(0,jsx_runtime.jsxs)(metadataUtils/* HtmlClassNameProvider */.e3,{className:(0,clsx_m["default"])(ThemeClassNames/* ThemeClassNames */.G.wrapper.blogPages,ThemeClassNames/* ThemeClassNames */.G.page.blogPostPage),children:[/*#__PURE__*/(0,jsx_runtime.jsx)(BlogPostPageMetadata,{}),/*#__PURE__*/(0,jsx_runtime.jsx)(BlogPostPageContent,{allPosts:allPosts,post:contentName,children:/*#__PURE__*/(0,jsx_runtime.jsx)(BlogPostContent,{})})]})});}const BlogItem=styled_components_browser_esm/* default */.Ay.div.withConfig({displayName:"BlogPostPage__BlogItem",componentId:"sc-a3o68z-0"})(["width:800px !important;margin:0 auto;@media (max-width:820px){width:100% !important;padding:",";box-sizing:border-box;}"],`${globals/* default */.Ay.STRUCTURE.PADDING.MOBILE}`);
