(self["webpackChunkpush_website"] = self["webpackChunkpush_website"] || []).push([[37643],{
...
/* harmony export */ });
/* harmony import */ var _docusaurus_theme_common__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(169024);
/* harmony import */ var _docusaurus_theme_common__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(117559);
...
/* harmony import */ var clsx__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(320053);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(296540);
/* harmony import */ var styled_components__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(944404);
/* harmony import */ var _site_src_config_pageMeta__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(353760);
/* harmony import */ var _docusaurus_router__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(956347);
/* harmony import */ var _docusaurus_useBaseUrl__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(486025);
/* harmony import */ var _site_src_config_globals__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(61530);
 ...
 * LICENSE file in the root directory of this source tree.
 */// Internal Configs
function BlogListPageMetadata(props){const{metadata}=props;const{siteConfig:{title:siteTitle}}=(0,_docusaurus_useDocusaurusContext__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .A)();const{blogDescription,blogTitle,permalink}=metadata;const location=(0,_docusaurus_router__WEBPACK_IMPORTED_MODULE_12__/* .useLocation */ .zy)();const pathname=location.pathname;const isBlogOnlyMode=permalink==='/';const isBlogMainPage=pathname.includes('/page/')||pathname=='/blog/'||pathname=='/blog';const title=isBlogOnlyMode?siteTitle:blogTitle;return/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_11__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_11__.Fragment,{children:[!isBlogMainPage&&/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_11__.jsx)(_docusaurus_theme_common__WEBPACK_IMPORTED_MODULE_13__/* .PageMetadata */ .be,{title:title,description:blogDescription}),/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_11__.jsx)(_theme_SearchMetadata__WEBPACK_IMPORTED_MODULE_6__/* ["default"] */ .A,{tag:"blog_posts_list"})]});}function BlogListPageContent(props){const{metadata,items,sidebar}=props;return/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_11__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_11__.Fragment,{children:[/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_11__.jsxs)(ListItem,{children:[/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_11__.jsx)(ListSpan,{children:metadata.page==1?'Recent Updates':`Page ${metadata.page}`}),metadata.page==1&&/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_11__.jsx)(_theme_BlogPostItems__WEBPACK_IMPORTED_MODULE_5__/* ["default"] */ .A,{items:items.slice(0,4),list:true})]}),/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_11__.jsx)(GridItem,{marginTop:metadata.page==1?true:false,children:/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_11__.jsx)(_theme_BlogPostItems__WEBPACK_IMPORTED_MODULE_5__/* ["default"] */ .A,{items:items.slice(metadata.page==1?4:0,11)})}),/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_11__.jsx)(PaginatorDiv,{children:/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_11__.jsx)(_theme_BlogListPaginator__WEBPACK_IMPORTED_MODULE_4__/* ["default"] */ .A,{metadata:metadata})})]});}function BlogListPage(props){const isSwiper=(0,_site_src_hooks_useMediaQuery__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .A)(`(max-width: 1199px)`);return/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_11__.jsx)(_docusaurus_theme_common__WEBPACK_IMPORTED_MODULE_13__/* .HtmlClassNameProvider */ .e3,{className:(0,clsx__WEBPACK_IMPORTED_MODULE_14__["default"])(_docusaurus_theme_common__WEBPACK_IMPORTED_MODULE_15__/* .ThemeClassNames */ .G.wrapper.blogPages,_docusaurus_theme_common__WEBPACK_IMPORTED_MODULE_15__/* .ThemeClassNames */ .G.page.blogListPage),children:/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_11__.jsxs)(_theme_BlogLayout__WEBPACK_IMPORTED_MODULE_3__/* ["default"] */ .A,{children:[/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_11__.jsx)(BlogListPageMetadata,{...props}),/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_11__.jsx)(BlogListPageContent,{...props})]})});}const GridItem=styled_components__WEBPACK_IMPORTED_MODULE_16__/* ["default"] */ .Ay.div.withConfig({displayName:"BlogListPage__GridItem",componentId:"sc-79af8x-0"})(["width:1120px !important;display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:33px;box-sizing:border-box;margin:",";@media (max-width:1200px){width:100% !important;padding:",";box-sizing:border-box;margin:10px auto 0 auto;gap:30px;}@media ","{grid-template-columns:repeat(1,minmax(0,1fr));}"],props=>props.marginTop?'100px auto 0 auto':'30px auto 0 auto',`${_site_src_config_globals__WEBPACK_IMPORTED_MODULE_10__/* ["default"] */ .Ay.STRUCTURE.PADDING.MOBILE}`,_site_src_config_globals__WEBPACK_IMPORTED_MODULE_10__/* .device */ .jO.tablet);const PaginatorDiv=styled_components__WEBPACK_IMPORTED_MODULE_16__/* ["default"] */ .Ay.div.withConfig({displayName:"BlogListPage__PaginatorDiv",componentId:"sc-79af8x-1"})(["width:100% !important;"]);const ListItem=styled_components__WEBPACK_IMPORTED_MODULE_16__/* ["default"] */ .Ay.div.withConfig({displayName:"BlogListPage__ListItem",componentId:"sc-79af8x-2"})(["display:flex;flex-direction:column;width:1120px;margin:50px auto auto auto;@media (max-width:1200px){width:100% !important;padding:",";box-sizing:border-box;margin:10px auto 0 auto;}"],`${_site_src_config_globals__WEBPACK_IMPORTED_MODULE_10__/* ["default"] */ .Ay.STRUCTURE.PADDING.MOBILE}`);const ListSpan=(0,styled_components__WEBPACK_IMPORTED_MODULE_16__/* ["default"] */ .Ay)(_site_src_css_SharedStyling__WEBPACK_IMPORTED_MODULE_1__/* .Span */ .L9).withConfig({displayName:"BlogListPage__ListSpan",componentId:"sc-79af8x-3"})(["color:var(--ifm-color-primary-blog);font-family:Strawford;font-size:37px;font-style:normal;font-weight:700;line-height:110%;letter-spacing:-1.2px;"]);
