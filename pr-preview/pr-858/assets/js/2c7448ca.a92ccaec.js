"use strict";
(self["webpackChunkpush_website"] = self["webpackChunkpush_website"] || []).push([[69739],{
...
const contentTitle = 'Intro to Message Types';
const metadata = {
  "id": "chat/docs-chat-message-types-section",
  "title": "Message Types",
  "description": "Each message of Push Chat is a json payload that carries with it a message type and some parameters that enable each frontend that integrates Push Chat to understand and display various message types.",
  "source": "@site/docs/chat/102-Message-Types-Section.mdx",
  "sourceDirName": "chat",
  "slug": "/chat/message-types",
  "permalink": "/push-website/pr-preview/pr-858/docs/chat/message-types",
  "draft": false,
  "unlisted": false,
  "editUrl": "https://github.com/push-protocol/push-website/blob/main/docs/chat/102-Message-Types-Section.mdx",
  "tags": [],
  "version": "current",
  "sidebarPosition": 102,
  "frontMatter": {
...
function _createMdxContent(props) {
  ...
  return (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.Fragment, {
    children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.h1, {
      id: "intro-to-message-types",
      children: "Intro to Message Types"
    }), "\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.p, {
      children: "Each message of Push Chat is a json payload that carries with it a message type and some parameters that enable each frontend that integrates Push Chat to understand and display various message types."
    }), "\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.p, {
      children: ["Push Chat supports an evergrowing list message types, all of which can be sent by ", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.code, {
        children: "chat.send"
      }), ", though some require passing few additional parameters."]
    }), "\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(Head, {
      children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("title", {
        children: `Intro to Message Types | Push Chat | Push Documentation`
      })
