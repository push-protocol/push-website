"use strict";
(self["webpackChunkpush_website"] = self["webpackChunkpush_website"] || []).push([[48447],{
...
const contentTitle = 'Fetch subscriptions overview';
const metadata = {
  "id": "notifications/build/docs-notifications-develop-fetch-subscriptions",
  "title": "Fetch Subscriptions",
  "description": "These APIs are useful for fetching list of all channels subscribed by a user and their settings (if any).",
  "source": "@site/docs/notifications/01-build/08-Develop-Fetch-Subscriptions.mdx",
  "sourceDirName": "notifications/01-build",
  "slug": "/notifications/build/fetch-subscriptions",
  "permalink": "/push-website/pr-preview/pr-858/docs/notifications/build/fetch-subscriptions",
  "draft": false,
  "unlisted": false,
  "editUrl": "https://github.com/push-protocol/push-website/blob/main/docs/notifications/01-build/08-Develop-Fetch-Subscriptions.mdx",
  "tags": [],
  "version": "current",
  "sidebarPosition": 8,
  "frontMatter": {
...
const toc = [{
  "value": "Fetch subscriptions API",
  "id": "fetch-subscriptions-api",
  "level": 2
}, {
  "value": "Fetch subscriptions parameters",
  "id": "fetch-subscriptions-parameters",
  "level": 3
}, {
  "value": "User settings overview",
...
function _createMdxContent(props) {
  ...
  return (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.Fragment, {
    children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.h1, {
      id: "fetch-subscriptions-overview",
      children: "Fetch subscriptions overview"
    }), "\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.p, {
      children: "These APIs are useful for fetching list of all channels subscribed by a user and their settings (if any)."
    }), "\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(Head, {
      children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("title", {
        children: `Fetch Subscriptions | Push Notifications | Push Documentation`
      })
    }), "\n", "\n", "\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.h2, {
      id: "fetch-subscriptions-api",
      children: "Fetch subscriptions API"
      ...
      children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.thead, {
        ...
        children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.tr, {
          children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.td, {
            ...
            children: "An object containing additional options for subscriptions"
          })]
      ...
      id: "user-settings-overview",
      children: "User settings overview"
    }), "\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.p, {
      children: ["User settings are optional preferences set by the users when they are subscribing to a channel, provided the ", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.a, {
        href: "/docs/notifications/build/fetch-subscriptions",
        children: "channel has enabled settings"
      }), ". User settings are always returned as a response to the API call along with their subscription to the channel."]
    }), "\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.p, {
      children: "This allows the channel to trigger notifications for certain categories (setting index) and enables users to choose what notifications they want to receive (for example: user might want to recieve loan liquidation alert when it reaches the threshold but not marketing notifications)."
    }), "\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.admonition, {
      type: "note",
      children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.p, {
        children: "Notification settings are guidelines that a channel should follow, Push nodes will not check for validity of a particular setting though it will filter out setting index (category) that a user has explicitly turned off."
      })
