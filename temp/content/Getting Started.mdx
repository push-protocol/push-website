...
<Details summary="Quick Guide to Getting Started with Push Protocol 🛣">
...
- Channels can send notifications to their users(wallet addresses) in a number of ways, including:
  ...
  - Users can gaslessly opt-in to receive notifications from these Channels. See the [**entire walkthrough here**](https://app.epns.io/#/live_walkthrough).
