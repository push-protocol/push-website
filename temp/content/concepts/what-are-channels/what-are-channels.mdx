...
How to Opt-In to a Channel? 👉  [**Opting-Into a Channel**](https://docs.push.org/users/epns-dapp/opting-in-to-a-channel)
...
<CustomLinkCard text="Create a Channel" link="../../developer-guides/creating-a-channel"/>
