...
const sidebars = {
  ...
  pushNotificationSidebar: [
    ...
    {
      type: 'doc',
      id: 'notification/docs-notification-quickstart',
    },
    {
      type: 'category',
      label: 'Build',
      link: {
        type: 'doc',
        id: 'notification/docs-notification-build-section',
      },
      collapsed: false,
      items: [{ type: 'autogenerated', dirName: 'notification/build' }],
    },
    {
      type: 'category',
      label: 'Tutorials',
      link: {
        type: 'doc',
        id: 'notification/docs-notification-tutorials-section',
      },
      collapsed: true,
      items: [{ type: 'autogenerated', dirName: 'notification/tutorials' }],
    },
    {
      type: 'category',
      label: 'Concepts',
      link: {
        type: 'doc',
        id: 'notification/docs-notification-concepts-section',
      },
      collapsed: true,
      items: [{ type: 'autogenerated', dirName: 'notification/concepts' }],
    },
  ],
  pushChatSidebar: [
    {
