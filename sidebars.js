...
const sidebars = {
  ...
  pushNotificationSidebar: [
    ...
    },
    {
      ...
      collapsed: false,
      items: [{ type: 'autogenerated', dirName: 'notifications/01-build' }],
    },
    {
      type: 'category',
      label: 'Tutorials',
    ...
    },
    {
      ...
      collapsed: true,
      items: [{ type: 'autogenerated', dirName: 'notifications/04-notification-standards' }],
    },
    {
      type: 'category',
      ...
      collapsed: true,
      items: [{ type: 'autogenerated', dirName: 'notifications/05-push-smart-contracts' }],
    },
  ],
  pushChatSidebar: [
    {
    ...
    },
    {
      ...
      collapsed: false,
      items: [{ type: 'autogenerated', dirName: 'chat/01-build' }],
    },
    {
      type: 'category',
      label: 'Message Types',
