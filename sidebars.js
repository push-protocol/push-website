...
const sidebars = {
  pushChainSidebar: [
    ...
    },
    {
      ...
      link: {
        type: 'doc',
        id: 'chain/docs-chain-ui-components',
      },
      collapsed: false,
      items: [{ type: 'autogenerated', dirName: 'chain/02-ui-components' }],
    },
    {
      type: 'category',
      label: 'Tutorials',
      ...
      collapsed: false,
      items: [{ type: 'autogenerated', dirName: 'chain/03-tutorials' }],
    },
    {
      type: 'category',
      label: 'Concepts',
      ...
      collapsed: false,
      items: [{ type: 'autogenerated', dirName: 'chain/04-concepts' }],
    },
  ],
