...
const sidebars = {
  ...
  pushDevsSidebar: [
    ...
    },
    {
      ...
      collapsed: true,
      items: [
        { type: "autogenerated", dirName: "devs/chat" }
      ]
    }
  ],
  pushChatSidebar: [
    ...
    },
    {
      ...
      link: {
        type: 'doc',
        id: 'devs/chat/devs-chat-build-section',
      },
      collapsed: false,
      items: [
        { type: "autogenerated", dirName: "devs/chat/build" },
      ]
    },
    {
      type: "category",
      ...
      link: {
        type: 'doc',
        id: 'devs/chat/devs-chat-message-types-section',
      },
      collapsed: false,
      items: [
        { type: "autogenerated", dirName: "devs/chat/message-types" },
      ]
    },
    {
      type: "category",
      ...
      link: {
        type: 'doc',
        id: 'devs/chat/devs-chat-ui-components-section',
      },
      collapsed: true,
      items: [
        { type: "autogenerated", dirName: "devs/chat/ui-components" },
      ]
    },
    {
      type: "category",
      ...
      link: {
        type: 'doc',
        id: 'devs/chat/devs-chat-tutorials-section',
      },
      collapsed: true,
      items: [
        { type: "autogenerated", dirName: "devs/chat/tutorials" },
      ]
    },
    {
      type: "category",
      ...
      link: {
        type: 'doc',
        id: 'devs/chat/devs-chat-concepts-section',
      },
      collapsed: true,
      items: [
        { type: "autogenerated", dirName: "devs/chat/concepts" },
      ]
    },
  ],
  // tutorialSidebar: [
