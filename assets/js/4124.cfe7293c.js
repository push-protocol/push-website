...
/* harmony export */ });
/* harmony import */ var _walletconnect_modal_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(341864);
class d{constructor(e){this.openModal=_walletconnect_modal_core__WEBPACK_IMPORTED_MODULE_0__/* .ModalCtrl */ .IP.open,this.closeModal=_walletconnect_modal_core__WEBPACK_IMPORTED_MODULE_0__/* .ModalCtrl */ .IP.close,this.subscribeModal=_walletconnect_modal_core__WEBPACK_IMPORTED_MODULE_0__/* .ModalCtrl */ .IP.subscribe,this.setTheme=_walletconnect_modal_core__WEBPACK_IMPORTED_MODULE_0__.ThemeCtrl.setThemeConfig,_walletconnect_modal_core__WEBPACK_IMPORTED_MODULE_0__.ThemeCtrl.setThemeConfig(e),_walletconnect_modal_core__WEBPACK_IMPORTED_MODULE_0__.ConfigCtrl.setConfig(e),this.initUi()}async initUi(){if(typeof window<"u"){await __webpack_require__.e(/* import() */ 6792).then(__webpack_require__.bind(__webpack_require__, 226792));const e=document.createElement("wcm-modal");document.body.insertAdjacentElement("beforeend",e),_walletconnect_modal_core__WEBPACK_IMPORTED_MODULE_0__.OptionsCtrl.setIsUiLoaded(!0)}}}
//# sourceMappingURL=index.js.map
