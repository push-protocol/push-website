...
const addEntity = function(name, alias = void 0) {
  if (entities[name] === void 0) {
    ...
    _mermaid_6dc72991_js__WEBPACK_IMPORTED_MODULE_6__.l.info("Added new entity :", name);
  } else if (entities[name] && !entities[name].alias && alias) {
    entities[name].alias = alias;
    _mermaid_6dc72991_js__WEBPACK_IMPORTED_MODULE_6__.l.info(`Add alias '${alias}' to entity '${name}'`);
  }
...
const addAttributes = function(entityName, attribs) {
  ...
  for (i = attribs.length - 1; i >= 0; i--) {
    ...
    _mermaid_6dc72991_js__WEBPACK_IMPORTED_MODULE_6__.l.debug("Added attribute ", attribs[i].attributeName);
  }
};
const addRelationship = function(entA, rolA, entB, rSpec) {
  ...
  _mermaid_6dc72991_js__WEBPACK_IMPORTED_MODULE_6__.l.debug("Added new relationship :", rel);
};
...
const erDb = {
  Cardinality,
  Identification,
  getConfig: () => (0,_mermaid_6dc72991_js__WEBPACK_IMPORTED_MODULE_6__.c)().er,
  addEntity,
  addAttributes,
  getEntities,
  addRelationship,
...
const drawAttributes = (groupNode, entityTextNode, attributes) => {
  ...
  attributes.forEach((item) => {
    ...
    let nodeHeight = 0;
    const attributeType = (0,_mermaid_6dc72991_js__WEBPACK_IMPORTED_MODULE_6__.x)(item.attributeType);
    const typeNode = groupNode.append("text").classed("er entityLabel", true).attr("id", `${attrPrefix}-type`).attr("x", 0).attr("y", 0).style("dominant-baseline", "middle").style("text-anchor", "left").style("font-family", (0,_mermaid_6dc72991_js__WEBPACK_IMPORTED_MODULE_6__.c)().fontFamily).style("font-size", attrFontSize + "px").text(attributeType);
    const nameNode = groupNode.append("text").classed("er entityLabel", true).attr("id", `${attrPrefix}-name`).attr("x", 0).attr("y", 0).style("dominant-baseline", "middle").style("text-anchor", "left").style("font-family", (0,_mermaid_6dc72991_js__WEBPACK_IMPORTED_MODULE_6__.c)().fontFamily).style("font-size", attrFontSize + "px").text(item.attributeName);
    const attributeNode = {};
    ...
    if (hasKeyType) {
      ...
      const keyTypeNode = groupNode.append("text").classed("er entityLabel", true).attr("id", `${attrPrefix}-key`).attr("x", 0).attr("y", 0).style("dominant-baseline", "middle").style("text-anchor", "left").style("font-family", (0,_mermaid_6dc72991_js__WEBPACK_IMPORTED_MODULE_6__.c)().fontFamily).style("font-size", attrFontSize + "px").text(keyTypeNodeText);
    ...
    if (hasComment) {
      const commentNode = groupNode.append("text").classed("er entityLabel", true).attr("id", `${attrPrefix}-comment`).attr("x", 0).attr("y", 0).style("dominant-baseline", "middle").style("text-anchor", "left").style("font-family", (0,_mermaid_6dc72991_js__WEBPACK_IMPORTED_MODULE_6__.c)().fontFamily).style("font-size", attrFontSize + "px").text(item.attributeComment || "");
...
const drawEntities = function(svgNode, entities2, graph) {
  ...
  keys.forEach(function(entityName) {
    ...
    const textNode = groupNode.append("text").classed("er entityLabel", true).attr("id", textId).attr("x", 0).attr("y", 0).style("dominant-baseline", "middle").style("text-anchor", "middle").style("font-family", (0,_mermaid_6dc72991_js__WEBPACK_IMPORTED_MODULE_6__.c)().fontFamily).style("font-size", conf.fontSize + "px").text(entities2[entityName].alias ?? entityName);
...
const drawRelationshipFromLayout = function(svg, rel, g, insert, diagObj) {
  ...
  const labelNode = svg.append("text").classed("er relationshipLabel", true).attr("id", labelId).attr("x", labelPoint.x).attr("y", labelPoint.y).style("text-anchor", "middle").style("dominant-baseline", "middle").style("font-family", (0,_mermaid_6dc72991_js__WEBPACK_IMPORTED_MODULE_6__.c)().fontFamily).style("font-size", conf.fontSize + "px").text(rel.roleA);
...
const draw = function(text, id, _version, diagObj) {
  conf = (0,_mermaid_6dc72991_js__WEBPACK_IMPORTED_MODULE_6__.c)().er;
  _mermaid_6dc72991_js__WEBPACK_IMPORTED_MODULE_6__.l.info("Drawing ER diagram");
  ...
  _mermaid_6dc72991_js__WEBPACK_IMPORTED_MODULE_6__.u.insertTitle(svg, "entityTitleText", conf.titleTopMargin, diagObj.db.getDiagramTitle());
