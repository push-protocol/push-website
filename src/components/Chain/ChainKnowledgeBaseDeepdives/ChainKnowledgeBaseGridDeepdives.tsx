...
import { ChainKnowledgeBaseDeepdivesConfig } from '../config/ChainKnowledgeBaseDeepdivesConfig';

const ChainKnowledgeBaseGridDeepdives = () => {
  const isMobile = useMediaQuery(device.mobileL);
  const isTablet = useMediaQuery(device.tablet);

  const gridRows = createGridRows(ChainKnowledgeBaseDeepdivesConfig);
...
export default ChainKnowledgeBaseGridDeepdives;
