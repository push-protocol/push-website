...
import { ChainKnowledgeBase101 } from '../config/ChainKnowledgeBase101';

const ChainKnowledgeBaseGrid101 = () => {
  const isMobile = useMediaQuery(device.mobileL);
  const isTablet = useMediaQuery(device.tablet);

  const gridRows = createGridRows(ChainKnowledgeBase101);

  console.log(gridRows, 'grid grid', ChainKnowledgeBase101);
...
export default ChainKnowledgeBaseGrid101;
