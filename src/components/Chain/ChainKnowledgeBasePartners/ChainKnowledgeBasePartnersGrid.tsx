...
import { ChainKnowledgeBasePartners } from '../config/ChainKnowledgeBasePartners';
import ChannelKnowledgeBaseComponentItem from '../ChainKnowledgeBase/ChannelKnowledgeBaseComponentItem';

const ChainKnowledgeBaseGridPartners = () => {
  const isMobile = useMediaQuery(device.mobileL);
  const isTablet = useMediaQuery(device.tablet);

  const gridRows = createGridRows(ChainKnowledgeBasePartners);

  console.log(gridRows, 'grid grid', ChainKnowledgeBasePartners);
  ...
  return (
    <ChainKnowledgeBaseGridWrapper>
      ...
      <ChainKnowledgeGridWrapper>
        ...
        <ChainKnowledgeGrid>
          {isTablet &&
            ChainKnowledgeBasePartners?.map((item, index) => (
              <ChannelKnowledgeBaseComponentItem item={item} index={index} />
            ))}
        </ChainKnowledgeGrid>
      </ChainKnowledgeGridWrapper>
...
export default ChainKnowledgeBaseGridPartners;
