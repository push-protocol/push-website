...
const RewardsActivityIcon: FC<RewardsActivityIconProp> = ({ type }) => {
  ...
  if (type === 'create_gated_group_push_chat') {
    return <GatedGroupPoints width={48} height={48} />;
  }
  ...
  if (
    ...
    return <SubscribePoints width={48} height={48} />;
  }

  if (type === 'setup_push_user_profile') {
    return <SetupProfilePoints width={48} height={48} />;
  }

  if (type === 'active_push_chat_user') {
    return <ActivePushPoints width={48} height={48} />;
  }

  if (type === 'hold_push_alpha_access_nft') {
    return <PushAlpha width={48} height={48} />;
  }

  if (type === 'hold_push_rockstar_nft') {
    return <RockstarNFT width={48} height={48} />;
  }

  if (type === 'create_channel_push') {
    return <CreateChannelPoints width={48} height={48} />;
  }

  if (type === 'reach_100_subscribers') {
    return <GreyBonusActivitySubscribers width={48} height={48} />;
  }

  if (type === 'reach_500_subscribers' || type === 'reach_1000_subscribers') {
    return <OrangeBonusActivitySubscribers width={48} height={48} />;
  }

  if (type === 'reach_5000_subscribers') {
    return <BlueBonusActivitySubscribers width={48} height={48} />;
  }

  if (type === 'reach_10000_subscribers') {
    return <YellowBonusActivitySubscribers width={48} height={48} />;
  }
  ...
  if (
    ...
    return <StakePushYellowCoin width={48} height={48} />;
  }
  ...
  if (
    ...
    return <StakePushGradientCoin width={48} height={48} />;
  }
  ...
  if (
    ...
    return <StakePushGreyMultiplier width={48} height={48} />;
  }
  ...
  if (
    ...
    return <StakePushOrangeMultiplier width={48} height={48} />;
  }
  ...
  if (
    ...
    return <StakePushOrangeDoubleStarMultiplier width={48} height={48} />;
  }
  ...
  if (
    ...
    return <StakePushBlueMultiplier width={48} height={48} />;
  }
  ...
  if (
    ...
    return <StakePushYellowMultiplier width={48} height={48} />;
  }
  ...
  if (
    ...
    return <StakePushGradientMultiplier width={48} height={48} />;
  }
