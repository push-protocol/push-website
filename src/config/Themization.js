...
const themeLight = {
  ...
  toastWarningBackground:
    'linear-gradient(90deg, #FFF2D1 0%, rgba(255, 255, 255, 0.00) 100%)',

  // Profile
  profileBG:
    'linear-gradient(107deg, rgba(226,8,128,1) 30%, rgba(103,76,159,1) 70%, rgba(53,197,243,1) 100%)',
  profileText: '#fff',
  ...
  vcModalBGColor:
    'linear-gradient(179.97deg, rgba(255, 255, 255, 0.6) 0.02%, rgba(236, 233, 250, 0.6) 123.25%)',
...
const themeDark = {
  ...
  toastWarningBackground:
    'linear-gradient(90deg, #66562D 0.03%, #2F3137 74.67%)',
