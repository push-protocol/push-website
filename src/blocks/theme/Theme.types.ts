...
export type SurfaceColors = keyof ThemeColorsConfig<{
  [semanticKeys.surface]: ColorSemantics['surface'];
}>;

export type TextColors = keyof ThemeColorsConfig<{
  [semanticKeys.text]: ColorSemantics['text'];
}>;

export type IconColors = keyof ThemeColorsConfig<{
  [semanticKeys.icon]: ColorSemantics['icon'];
}>;

export type StrokeColors = keyof ThemeColorsConfig<{
  [semanticKeys.stroke]: ColorSemantics['stroke'];
}>;
