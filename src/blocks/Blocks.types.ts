...
export type BlocksColorData = {
  [K in keyof typeof blocksColorsLegacy as CamelCase<
    K extends string ? K : never
  >]: (typeof blocksColorsLegacy)[K];
};
...
export type BorderValue =
  | `${ThemeBorderSize} ${string} ${StrokeColors}`
  | 'none';
