...
import { useIsVisible } from '@site/src/hooks/useIsInvisible';
import { textVariants } from '../text';

const RadixTooltipContent = styled(RadixTooltip.Content).withConfig({
  shouldForwardProp: (prop) =>
    !tooltipCSSPropsKeys.includes(prop as keyof TooltipProps),
})<TooltipProps>`
...
const Tooltip: FC<TooltipProps> = ({
  ...
  return (
    <RadixTooltip.Provider>
      <RadixTooltip.Root delayDuration={250} open={visible && isInView}>
