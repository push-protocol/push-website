  ...
  return (
    <Layout title={PageMeta.TOS.pageTitle} description={PageMeta.TOS.pageDescription} showNavbar='website'>
       <Head>
        ...
        <meta property="og:image" content={useBaseUrl(require("/static/assets/previews/tospreview.png").default, { absolute: true})} />
        ...
        <meta property="twitter:image" content={useBaseUrl(require("/static/assets/previews/tospreview.png").default, { absolute: true})} />
          ...
          >
            <ItemV>
              ...
              <P testAlign="center" size="1.3rem" color="#fff">
                <B color="#fff">IMPORTANT NOTICE: </B>THIS AGREEMENT IS SUBJECT TO BINDING ARBITRATION AND A WAIVER OF CLASS
            ...
            >
              ...
              >
                ...
                <P margin="-10px 0px 0px">
                  <B>&quot;Push&rdquo;</B>, <B>&quot;we,&rdquo;</B> <B>&quot;us&rdquo;</B> or{' '}
                  <B>&quot;our&rdquo;</B> provides an experimental open source protocol comprising a set of Ethereum
                  based smart contracts (the <B>&quot;Push Protocol&rdquo;</B>) that enables any service / DApp or
                  ...
                  or any other subdomains associated with <B>push.org</B>, including any mobile application or any
                  similar frontend interface that can interact with blockchain smart contracts (the{' '}
                  <B>&quot;App&rdquo;</B>). Channels and subscribers/users interact directly in a peer to peer
                ...
                <P margin="20px 0px 0px">
                  ...
                  <B>&quot;Content&rdquo;</B>). All Content created by you is solely your responsibility and you
                ...
                <P margin="20px 0px 0px">
                  ...
                  time by Push are referred to here as (the <B>&quot;Services&rdquo;</B>). Please read these Terms
                  of Use (these <B>&quot;Terms&rdquo;</B>) carefully before using the Services. By using or
                ...
                <P margin="20px 0px 0px 20px">
                  <B>(a)</B> you are of the legal age of majority in your jurisdiction as is required to access such
                  Services and Content and enter into arrangements as provided by the Services;
                </P>

                <P margin="20px 0px 0px 20px">
                  <B>(b)</B> (in the case of a corporation) you are duly incorporated and in good standing under the
                  laws of your jurisdiction of incorporation;
                </P>

                <P margin="20px 0px 0px 20px">
                  <B>(c)</B> you are fully able and competent to enter into the terms, conditions, obligations,
                  affirmations, representations and warranties set forth in these Terms and to abide by and comply with
                  these Terms;
                </P>

                <P margin="20px 0px 0px 20px">
                  <B>(d)</B> the execution and performance of these Terms shall not violate or conflict with the
                  terms or conditions of any other agreement to which you are a party or by which you are bound;
                </P>

                <P margin="20px 0px 0px 20px">
                  <B>(e)</B> you have the right, power, and authority to enter into these terms, grant the rights
                  granted by it herein, and perform your obligations without the consent or approval of any third party
                  or governmental or regulatory authority;
                </P>

                <P margin="20px 0px 0px 20px">
                  <B>(f)</B> you are legally permitted to use the service in your jurisdiction including owning
                  cryptographic tokens of value, and interacting with the Services or Content in any way;
                </P>

                <P margin="20px 0px 0px 20px">
                  <B>(g)</B> you are responsible for ensuring compliance with the laws of all applicable
                ...
                <P margin="20px 0px 0px 20px">
                  <B>(h)</B> you have not relied and shall not rely upon Push for legal advice regarding your
                  compliance with applicable law; and
                </P>

                <P margin="20px 0px 20px 20px">
                  <B>(i)</B> you and your financial institutions, or any party that owns or controls you or your
                ...
                <TermsHeaderGroup>
                  ...
                  <P margin="0">While using the Site, the App or the Services you agree not to:</P>
                </TermsHeaderGroup>

                <P margin="20px 0px 0px 20px">
                  <B>(a)</B> restrict or inhibit any other user from using the Site, the App, the Services or the
                  Content, including without limitation, by means of &quot;hacking&rdquo; or defacing any portion of the
                  Site or the App;
                </P>

                <P margin="20px 0px 0px 20px">
                  <B>(b)</B> use the Site, the App, the Services or Content for any unlawful purpose or in any
                  manner not intended by Company or as contemplated herein and on the Site or the App;
                </P>

                <P margin="20px 0px 0px 20px">
                  <B>(c)</B> engage in rude, unlawful, harassing, vulgar, obscene, hateful, threatening, abusive or
                  otherwise objectionable behaviour;
                </P>

                <P margin="20px 0px 0px 20px">
                  <B>(d)</B> institute an attack upon any server used in connection with the Site or the App or any
                  portion thereof or otherwise attempt to disrupt such servers;
                </P>

                <P margin="20px 0px 0px 20px">
                  <B>(e)</B> express or imply that any statements you make are endorsed by Push, without our prior
                  express written consent;
                </P>

                <P margin="20px 0px 0px 20px">
                  <B>(f)</B> knowingly transmit: (i) any content or information that is unlawful, fraudulent,
                ...
                <P margin="20px 0px 0px 20px">
                  <B>(h)</B> transmit any software or other materials that contain any viruses, worms, trojan
                  horses, defects, date bombs, time bombs or other items of a destructive nature;
                </P>

                <P margin="20px 0px 0px 20px">
                  <B>(i)</B> modify, adapt, sublicense, translate, reverse engineer, decompile or disassemble all or
                  any portion of the Site or the App;
                </P>

                <P margin="20px 0px 0px 20px">
                  <B>(j)</B> remove, alter, conceal any copyright, trademark, patent or other proprietary rights
                  notices contained in the Site or the App;
                </P>

                <P margin="20px 0px 0px 20px">
                  <B>(k)</B> link the Site or the App or any Content thereon to any third party website or portion
                  thereof;
                </P>

                <P margin="20px 0px 0px 20px">
                  <B>(l)</B> use any robot, spider, site search/retrieval application or other manual or automatic
                ...
                <P margin="20px 0px 20px 20px">
                  <B>(m)</B> harvest or collect information about users of the Site or the App without their express
                  consent.
                </P>
                ...
                <ListGroup>
                  ...
                  <P margin="-10px 0px 0px 20px">
                    Software and services provided by our affiliates (<B>&quot;Affiliated Services&rdquo;</B>) and
                    third party software and services (<B>&quot;Third Party Services&rdquo;</B> and, together with
                    Affiliated Services, <B>&quot;Additional Services&rdquo;</B>) included in, integrated into, or
                    ...
                    <B>&quot;Service Providers&rdquo;</B>) (for example, Infura, Google Analytics, etc). Please
                  ...
                  <P margin="20px 0px 0px 40px">
                    <B>(a)</B> caused by factors outside of our reasonable control, including any force majeure
                    event or Internet access or related problems;
                  </P>

                  <P margin="20px 0px 0px 40px">
                    <B>(b)</B> that result from any voluntary actions or inactions from you or any third party
                  ...
                  <P margin="20px 0px 0px 40px">
                    <B>(c)</B> that result from you not following any best/industry practices or standards as
                    notified to you;
                  </P>

                  <P margin="20px 0px 0px 40px">
                    <B>(d)</B> that result from your equipment, software or other technology and/or third party
                    equipment, software or other technology (other than third party equipment within our direct
                    control); or
                  </P>

                  <P margin="20px 0px 20px 40px">
                    <B>(e)</B> arising from our suspension or termination of your right to use the Site, the App or
                  ...
                  <P margin="-10px 0px 20px 20px">
                    ...
                    Terms, <B>&quot;Sensitive Data&rdquo;</B> means (a) social security number, passport number,
                ...
                <ListGroup>
                  ...
                  <P margin="-10px 0px 0px 20px">
                    ...
                    Site, the App and the Services (collectively, <B>&quot;Access&rdquo;</B>). This Access shall
                  ...
                  <P margin="20px 0px 0px 20px">
                    ...
                    wearable devices, speakers and/or other devices (<B>&quot;Devices&rdquo;</B>).
                  </P>
                  ...
                  <P margin="20px 0px 0px 20px">
                    All Push trademarks, service marks, trade names, logos, domain names, and any other features of the
                    Push brand (<B>&quot;Push Brand Features&rdquo;</B>) are the sole property of Push or its
                ...
                <ListGroup>
                  ...
                  <P margin="20px 0px 0px 20px">
                    <B>(c)</B> any of your acts or omissions that implicate publicity rights, defamation or invasion
                    of privacy.
                  </P>
                </ListGroup>
              ...
              >
                ...
                <P margin="0px 0px 20px 0px">
                  ...
                  International Arbitration Centre (the <B>&quot;Rules&rdquo;</B>) for the time being in force,
                ...
                <P margin="-10px 0px 20px 0px">
                  ...
                  If any court or arbitrator determines that the class action waiver set forth in this Pgraph is void
