...
function PrivacyMobile() {
  return (
    <PageWrapper
      ...
      pageTitle={PageMeta.PRIVACY.pageTitle}
    >
      <PrivacyMobileWrapper>
        <ResponsiveSection curve="bottom" padding="80px 0px 20px 0px" data-bkg="dark">
          <Content className="contentBox" flex="0">
            <ItemH flexDirection="column" justifyContent="flex-start">
              <HeroHeader>PRIVACY POLICY MOBILE APPS</HeroHeader>
              <Para margin="20px 0 0 0" size="1.5rem">Defines how EPNS collects, handles and processes data.</Para>

              <ItemV align="flex-start" margin="0">
                <H3 maxWidth="400px">LAST UPDATED: 24TH SEPTEMBER 2022</H3>
              </ItemV>
        ...
        <ResponsiveSection curve="bottom" padding="80px 0px 40px 0px" data-bkg="light">
          <Content className="contentBox">
            ...
            <ItemH align="stretch" justifyContent="flex-start" margin="0px 20px 40px 20px" flexDirection="column">
              <ItemH align="flex-start" margin="30px 0px 20px 0px" justifyContent="flex-start">
                {/* SUMMARY */}
                ...
                <Para>
                This policy (the Policy) outlines how we collect, use, store and disclose your personal data. Please take a moment to read about how we collect, use and/or disclose your personal data so that you know and understand the purposes for which we may collect, use and/or disclose your personal data. By accessing the &quot;EPNS&rdquo; application available on Google Play or Apple App Store (the App), you agree and consent to Ethereum Push Notification Service Foundation (the Company), its related corporations, business units and affiliates, as well as their respective representatives and/or agents (collectively referred to herein as EPNS, us, we or our), collecting, using, disclosing and sharing amongst themselves the personal data, and to disclosing such personal data to relevant third party providers. This Policy supplements but does not supersede nor replace any other consent which you may have previously provided to us nor does it affect any rights that we may have at law in connection with the collection, use and/or disclosure of your personal data. We may from time to time update this Policy to ensure that this Policy is consistent with our future developments, industry trends and/or any changes in legal or regulatory requirements. Subject to your rights at law, the prevailing terms of this Policy shall apply. For the avoidance of doubt, this Policy forms part of the terms and conditions governing your relationship with us and should be read in conjunction with such terms and conditions.
                </Para>

            
                {/* What personal data is collected by EPNS */}
                <Para weight="400" spacing="0.2em" color="#000" textTransform="uppercase" size="1.2em">
                    1 What personal data is collected by EPNS
                </Para>
                <Para margin="-10px 0px 0px 0px">
                &quot;Personal data&rdquo; means data, whether true or not, about an individual who can be identified (i) from that data, or (ii) from that data and other information to which the organisation has or is likely to have access. Personal data may be collected when you interact with our services or use the App, or may be received by EPNS from third-party databases or service providers that provide business information. For example, EPNS may collect personal data such as particulars of digital wallet addresses, transactions performed by said digital wallet addresses, public cryptographic key relating to digital wallet addresses on distributed ledger networks and/or similar information.
                </Para>
                ...
                <Para margin="-10px 0px 0px 0px">
                Blockchain technology, also known as distributed ledger technology (DLT), is at the core of our business. Blockchains are decentralized and made up of digitally recorded data in a chain of packages called &quot;blocks&rdquo;. The manner in which these blocks are linked is chronological, meaning that the data is very difficult to alter once recorded. Since the ledger may be distributed all over the world (across several &quot;nodes&rdquo; which usually replicate the ledger) this means there is no single person making decisions or otherwise administering the system (such as an operator of a cloud computing system), and that there is no centralized place where it is located either.
                </Para>

                <Para margin="20px 0px 0px 0px">
                Accordingly, by design, a blockchain’s data cannot be changed or deleted and is said to be &quot;immutable&rdquo;. This may affect your ability to exercise your rights such as your right to erasure (&quot;right to be forgotten&rdquo;), or your rights to object or restrict processing of your personal data. Data on the blockchain cannot be erased and cannot be changed. Although smart contracts may be used to revoke certain access rights, and some content may be made invisible to others, it is not deleted.
                </Para>
                ...
                EPNS may collect, use and/or disclose your personal data for its legitimate interests or business purposes, including operations for these purposes. These may include, without limitation, the following:
                </Para>
                ...
                <ListGroup>
                  ...
                  <Para margin="20px 0px 0px 40px">
                    <B>(i)</B> services for sending of push-notifications, information updates, notices or correspondence;
                  </Para>

                  <Para margin="20px 0px 0px 40px">
                    <B>(ii)</B> acting as intermediaries through any blockchain, network or platform;
                  </Para>

                  <Para margin="20px 0px 0px 40px">
                    <B>(iii)</B> recording and/or encryption on any blockchain, network or platform;
                  </Para>
                  ...
                  <Para margin="20px 0px 0px 40px">
                    <B>(v)</B> various products and/or services (whether digital or not, and whether provided through an external service provider or otherwise);
                  </Para>

                  <Para margin="20px 0px 0px 40px">
                    <B>(vi)</B> making payments for participation in any blockchain, network or platform developed or managed by us (as applicable);
                  </Para>

                  <Para margin="20px 0px 0px 40px">
                    <B>(vii)</B> carrying out research, planning and statistical analysis;
                  </Para>

                  <Para margin="20px 0px 0px 40px">
                    <B>(viii)</B> trouble-shooting, technical maintenance and bug fixes; and/or
                  </Para>

                  <Para margin="20px 0px 0px 40px">
                    <B>(ix)</B> analytics for the purposes of developing or improving our products, services, security, service quality, staff training, and advertising strategies;
                  </Para>

                  <Para margin="20px 0px 0px 20px">
                    <B>(b)</B> communicating with you, including providing you with updates on changes to services or products (whether made available by us or through us) including any additions, expansions, suspensions and replacements of or to such services or products and their terms and conditions;
                  </Para>

                  <Para margin="20px 0px 0px 20px">
                    <B>(c)</B> managing our infrastructure and business operations and complying with internal policies and procedures;
                  </Para>
                  ...
                  <Para margin="20px 0px 0px 20px">
                    <B>(e)</B> complying with all applicable laws, regulations, rules, directives, orders, instructions and requests from any local or foreign authorities, including regulatory, governmental, tax and law enforcement authorities or other authorities;
                  </Para>

                  <Para margin="20px 0px 0px 20px">
                    <B>(f)</B> enabling any actual or proposed assignee or transferee, participant or sub-participant of EPNS&apos;s rights or obligations to evaluate any proposed transaction;
                  </Para>

                  <Para margin="20px 0px 0px 20px">
                    <B>(g)</B> enforcing obligations owed to us, protecting our rights or property, and protecting against legal liability; and/or
                  </Para>

                  <Para margin="20px 0px 0px 20px">
                    <B>(h)</B> seeking professional advice, including legal or tax advice.
                  </Para>
             ...
             You are responsible for ensuring that the personal data you provide to us is accurate, complete, and not misleading and that such personal data is kept up to date. You acknowledge that failure on your part to do so may result in our inability to provide you with the products and services you have requested. To update your personal data, please contact us (please see section 11 below for contact details). Where you provide us with personal data concerning individuals other than yourself, you are responsible for obtaining all legally required consents from the concerned individuals and you shall retain proof of such consent(s), such proof to be provided to us upon our request.
                ...
                <Para margin="0px 0px 0px 0px">
                To contact us on any aspect of this Policy or your personal data or to provide any feedback that you may have, please contact our Data Protection Officer at <A href="mailto://support@epns.io">support@epns.io</A>.
                </Para>
                ...
                <Para margin="20px 0px 0px 20px">
                  <B>(d)</B> rights in relation to automated decision-making and profiling (you have the right to be free from decisions based solely on automated processing of your personal data, including profiling, that affect you, unless such processing is necessary for entering into, or the performance of, a contract between you and us or you provide your explicit consent to such processing);
                </Para>

                <Para margin="20px 0px 0px 20px">
                  <B>(e)</B> the right to restrict further processing of your personal data (unless we demonstrate compelling legitimate grounds for the processing);
                </Para>
                ...
                <Para margin="20px 0px 0px 0px">
                By using the App and/or any services provided by EPNS, you signify your acceptance of this Policy and terms of service. If you do not agree to this Policy or terms of service, please do not use the App or any services provided by EPNS. Your continued use of the App following the posting of changes to this Policy will be deemed your acceptance of those changes.
                </Para>
