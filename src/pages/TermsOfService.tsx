...
function TermsOfService() {
  return (
    ...
    >
      ...
      {/* TOS SECTION */}
      <ResponsiveSection padding="80px 0px 40px 0px" data-bkg="light">
        <Content className="contentBox">
          <ItemH align="stretch" justifyContent="flex-start" margin="0px 20px 40px 20px" flexDirection="column">
            <ItemH align="flex-start" margin="30px 0px 20px 0px" justifyContent="flex-start">
              ...
              <Para weight="400" spacing="0.2em" textTransform="uppercase" size="1.2em">
                1. ACCEPTANCE OF TERMS
              </Para>
              ...
              <Para margin="20px 0px 0px">
                The content of the notifications will be created by you, is presented to the subscriber/user in a variety of ways including images, data, text, messages, video or audio (collectively, the <B>&quot;Content&rdquo;</B>). All Content created by you is solely your responsibility and you must evaluate and bear all risks associated with the use and distribution of any of your Content.
              </Para>
              ...
              <Para weight="400" spacing="0.2em" color="#FFF" textTransform="uppercase" size="1.2em">
              ...
              <Para margin ="20px 0px 0px 20px">
                <B>(a)</B> restrict or inhibit any other user from using the Site, the App, the Services or the Content, including without limitation, by means of &quot;hacking&rdquo; or defacing any portion of the Site or the App;
              </Para>
              ...
              <Para margin ="20px 0px 0px 20px">
                <B>(l)</B> use any robot, spider, site search/retrieval application or other manual or automatic device or process to retrieve, index, &quot;data mine&rdquo; or in any way reproduce or circumvent the navigational structure or presentation of the Site or the App or its contents; or
              </Para>
              ...
              <ListGroup>
                ...
                <Para weight="400" spacing="0.2em" color="#FFF" margin="0px 0px 20px 20px" textTransform="uppercase" size="1.1em">
                  6.1 Risk of Cryptographic Systems
                </Para>
                ...
                <Para margin="-10px 0px 0px 20px">
                  Software and services provided by our affiliates (<B>&quot;Affiliated Services&rdquo;</B>) and third party software and services (<B>&quot;Third Party Services&rdquo;</B> and, together with Affiliated Services, <B>&quot;Additional Services&rdquo;</B>) included in, integrated into, or made accessible through, the Services, including through the Snap System, are made available to you under the terms of use of such service providers (collectively, <B>&quot;Service Providers&rdquo;</B>) (for example, Infura, Google Analytics, etc). Please conduct your own research and due diligence, and review the applicable terms of use on their websites prior to using or accessing their services.
                </Para>
              ...
              {/* 8. Links */}
              <Para weight="400" spacing="0.2em" color="#FFF" margin="20px 0px 20px 0px" textTransform="uppercase" size="1.1em">
                8. Links
              </Para>
            ...
            {/* Schedule A */}
            <ItemH align="flex-start" margin="0px 0px 20px 0px" justifyContent="flex-start">
              <H2 textTransform="uppercase" spacing="0.1em" className='scheduleHeader'>
                <Span bg="#000" weight="600" padding="0px 8px">Schedule</Span>
                <Span weight="600" color="#fff" bg="#e20880" padding="0px 8px">A</Span>
              </H2>
            </ItemH>
            ...
            <ItemH align="flex-start" margin="-30px 0px 20px 0px" justifyContent="flex-start">
              ...
              <ListGroup>
                {/* 1. Entire Agreement */}
                <Para weight="400" spacing="0.2em" color="#FFF" margin="0px 0px 20px 0px" textTransform="uppercase" size="1.1em">
                1. ENTIRE AGREEMENT
                </Para>
                <Para margin="-10px 0px 0px 20px">
            ...
            {/* Schedule B */}
            <ItemH align="flex-start" margin="20px 0px 20px 0px" justifyContent="flex-start">
              <H2 textTransform="uppercase" spacing="0.1em" className='scheduleHeader'>
                <Span bg="#000" color="#fff" weight="600" padding="0px 8px">Schedule</Span>
                <Span weight="600" color="#fff" bg="#e20880" padding="0px 8px">B</Span>
              </H2>
            </ItemH>
            ...
            <ItemH align="flex-start" margin="-30px 0px 20px 0px" justifyContent="flex-start">
              ...
              <Para color="#FFF" margin="-10px 0px 20px 0px" textTransform="uppercase">
