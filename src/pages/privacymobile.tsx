        ...
        <Content className='contentBox'>
          ...
          >
            ...
            >
              ...
              <P>
                This policy (the Policy) outlines how we collect, use, store and
                disclose your personal data. Please take a moment to read about
                how we collect, use and/or disclose your personal data so that
                you know and understand the purposes for which we may collect,
                use and/or disclose your personal data. By accessing the
                &quot;Push&rdquo; application available on Google Play or Apple
                App Store (the App), you agree and consent to Ethereum Push
                Notification Service Foundation (the Company), its related
                corporations, business units and affiliates, as well as their
                respective representatives and/or agents (collectively referred
                to herein as Push, us, we or our), collecting, using, disclosing
                and sharing amongst themselves the personal data, and to
                disclosing such personal data to relevant third party providers.
                ...
                data. We may from time to time update this Policy to ensure that
                this Policy is consistent with our future developments, industry
                ...
                relationship with us and should be read in conjunction with such
              ...
              <P margin='-10px 0px 0px 0px'>
                ...
                organisation has or is likely to have access. Personal data may
                be collected when you interact with our services or use the App,
                or may be received by Push from third-party databases or service
                providers that provide business information. For example, Push
                may collect personal data such as particulars of digital wallet
                addresses, transactions performed by said digital wallet
                addresses, public cryptographic key relating to digital wallet
              ...
              <P margin='-10px 0px 0px 0px'>
                ...
                which these blocks are linked is chronological, meaning that the
                data is very difficult to alter once recorded. Since the ledger
                may be distributed all over the world (across several
                ...
                computing system), and that there is no centralized place where
                it is located either.
              </P>

              <P margin='20px 0px 0px 0px'>
                Accordingly, by design, a blockchain’s data cannot be changed or
                deleted and is said to be &quot;immutable&rdquo;. This may
                affect your ability to exercise your rights such as your right
                to erasure (&quot;right to be forgotten&rdquo;), or your rights
                to object or restrict processing of your personal data. Data on
                the blockchain cannot be erased and cannot be changed. Although
                smart contracts may be used to revoke certain access rights, and
                some content may be made invisible to others, it is not deleted.
              </P>
              ...
              <P margin='20px 0px 0px 0px'>
                ...
                with you.{' '}
                <B>
                  IF YOU WANT TO ENSURE YOUR PRIVACY RIGHTS ARE NOT AFFECTED IN
                  ANY WAY, YOU SHOULD NOT TRANSACT ON BLOCKCHAINS AS CERTAIN
                  RIGHTS MAY NOT BE FULLY AVAILABLE OR EXERCISABLE BY YOU OR US
                  DUE TO THE TECHNOLOGICAL INFRASTRUCTURE OF THE BLOCKCHAIN. IN
                  PARTICULAR THE BLOCKCHAIN IS AVAILABLE TO THE PUBLIC AND ANY
                  PERSONAL DATA SHARED ON THE BLOCKCHAIN WILL BECOME PUBLICLY
                  AVAILABLE.
                </B>
              </P>
              ...
              <P margin='0px 0px 0px 0px'>
                ...
                legitimate interests or business purposes, including operations
                for these purposes. These may include, without limitation, the
                following:
              </P>
              ...
              <ListGroup>
                ...
                <P margin='20px 0px 0px 40px'>
                  <B>(viii)</B> trouble-shooting, technical maintenance and bug
                  fixes; and/or
                </P>
                ...
                <P margin='20px 0px 0px 20px'>
                  ...
                  with updates on changes to services or products (whether made
                  available by us or through us) including any additions,
                  expansions, suspensions and replacements of or to such
                  services or products and their terms and conditions;
                </P>

                <P margin='20px 0px 0px 20px'>
                  <B>(c)</B> managing our infrastructure and business operations
                ...
                <P margin='20px 0px 0px 20px'>
                  <B>(h)</B> seeking professional advice, including legal or tax
                  advice.
                </P>

                <P>
                  We may also use personal data for purposes set out in the
                  terms and conditions that govern our relationship with you or
                  our customer.
                </P>
              </ListGroup>
              ...
              <P margin='0px 0px 0px 0px'>
                ...
                insurance companies, agents, contractors or third party service
                providers who provide services to us such as telecommunications,
                information technology, payment, data processing, storage and
                archival, and our professional advisers such as our auditors and
                lawyers, and regulators and authorities), located in any
                jurisdiction, in order to carry out the purposes set out above.
                Please be assured that when we disclose your personal data to
                such parties, we will disclose only the personal information
                that is necessary to deliver the service required, and will also
              ...
              <P margin='20px 0px 0px 0px'>
                ...
                for more information (please see section 11 below).
              </P>
              ...
              <P margin='20px 0px 0px 0px'>
                ...
                section 11 below for contact details). Where you provide us with
              ...
              <P margin='20px 0px 20px 0px'>
                ...
                data in any jurisdiction, and accordingly such personal data may
                be transferred to computers, servers or hardware located outside
                of your state, province, country or other governmental
                jurisdiction where the data protection laws may differ from
                those in your jurisdiction. Push will take all steps reasonably
                ...
                there are adequate controls in place including the security of
                your data and other personal information (including without
                limitation the Standard Contractual Clauses approved by the
                European Commission). Your consent to this Policy followed by
                your submission of such information represents your agreement to
                the transfer of personal data as described herein.
              </P>
              ...
              <P margin='0px 0px 0px 0px'>
                ...
                browser information, computer or device type, operating system,
                internet service provider, App usage, date/time stamp, and
                functions as your credentials for accessing the App. We use
                tokens, cookies and other technologies to facilitate your
                internet sessions and use of the App, offer you customised
                products and/or services according to your preferred settings,
                display features and services which might be of interest to you
                (including ads on our services), track usage of the App, to
                compile statistics about activities carried out on the App, and
                to hold certain information.
              </P>

              <P margin='20px 0px 0px 0px'>
                You may set up your web browser to block or remove tokens stored
                from your computer or mobile device. However, if you do so, you
                may not be able to use certain features and functions of the
                App.
              </P>

              <P margin='20px 0px 20px 0px'>
                Tokens will also be deleted when you uninstall the App from your
              ...
              <P margin='0px 0px 0px 0px'>
                ...
                our legitimate purposes, such as transfers of digital assets,
                and dealing with any disputes or concerns that may arise.
              </P>

              <P margin='20px 0px 0px 0px'>
                We may need to retain information for a longer period where we
                need the information to comply with regulatory or legal
                requirements or where we may need it for our legitimate purposes
                (e.g. to help us respond to queries or complaints, fighting
                fraud and financial crime, responding to requests from
                regulators etc).
              </P>
              ...
              <ListGroup>
                ...
                <P margin='20px 0px 0px 0px'>
                  ...
                  position to continue to provide our services or products to
                  you or administer any contractual relationship in place. Such
              ...
              <P margin='0px 0px 0px 0px'>
                ...
                updated Policy on the App. You are encouraged to visit the App
                from time to time to ensure that you are well informed of our
                latest policies in relation to personal data protection. All
                communications, transactions and dealings with us shall be
              ...
              <P margin='0px 0px 0px 0px'>
                This section 12 applies if you are an individual located in the
              ...
              <P margin='20px 0px 0px 0px'>
                ...
                not use the App or any services provided by Push. Your continued
                use of the App following the posting of changes to this Policy
