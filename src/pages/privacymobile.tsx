              ...
              >
                ...
                <ListGroup>
                  ...
                  <P margin="20px 0px 0px 40px">
                    <B>(i)</B> services for sending of push-notifications, information updates, notices or
                    correspondence;
                  </P>
                  ...
                  <P margin="20px 0px 0px 40px">
                    <B>(vi)</B> making payments for participation in any blockchain, network or platform developed
                  ...
                  <P margin="20px 0px 0px 40px">
                    <B>(ix)</B> analytics for the purposes of developing or improving our products, services,
                    security, service quality, staff training, and advertising strategies;
                  </P>

                  <P margin="20px 0px 0px 20px">
                    <B>(b)</B> communicating with you, including providing you with updates on changes to services
                  ...
                  <P margin="20px 0px 0px 20px">
                    <B>(c)</B> managing our infrastructure and business operations and complying with internal
                  ...
                  <P margin="20px 0px 0px 20px">
                    <B>(e)</B> complying with all applicable laws, regulations, rules, directives, orders,
                  ...
                  <P margin="20px 0px 0px 20px">
                    <B>(f)</B> enabling any actual or proposed assignee or transferee, participant or
                    sub-participant of Push&apos;s rights or obligations to evaluate any proposed transaction;
                  </P>

                  <P margin="20px 0px 0px 20px">
                    <B>(g)</B> enforcing obligations owed to us, protecting our rights or property, and protecting
                ...
                <P margin="20px 0px 0px 20px">
                  <B>(d)</B> rights in relation to automated decision-making and profiling (you have the right to be
                ...
                <P margin="20px 0px 0px 20px">
                  <B>(e)</B> the right to restrict further processing of your personal data (unless we demonstrate
