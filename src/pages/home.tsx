...
// Internal Configs
import { ChatFeaturesList, ChatUseCasesList } from "@site/src/config/HomeChatFeaturesList";
import { InvList } from "@site/src/config/HomeInvestorList";
import { NotifFeaturesList, NotifUseCasesList } from "@site/src/config/HomeNotifFeaturesList";
      ...
      <HomeWrapper className="home-wrapper">
          ...
          <HeroContent alignSelf="center">
            ...
            <HeroPrimary flex="initial" justifyContent="flex-start">
              ...
              >
                ...
                >
                  <StarColoredIcon />
                  <H2 fontSize="14px" fontFamily="FK Grotesk Neue">
                ...
                <HeroBody>
                  ...
                  >
                    ...
                    Push is a web3 native communication network, enabling
                    cross-chain notifications, messaging, and more for apps,
        ...
        <NotificationSection id="notification-section">
          <Content className="contentBox" alignSelf="center">
            <ItemV maxWidth={"849px"} margin="0px auto 72px auto">
              <H2
                color="#DDD8D8"
          ...
          >
            ...
            <ChatGridSystem>
              <ChatGridItem maxWidth="282px">
                {ChatFeaturesList?.first?.map((item) => (
                  <Glassy item={item} />
                ))}
              </ChatGridItem>
              ...
              <ChatGridItem maxWidth="282px" lastRow={true}>
                {ChatFeaturesList?.third?.map((item) => (
                  <Glassy item={item} />
                ))}
              </ChatGridItem>
            </ChatGridSystem>
