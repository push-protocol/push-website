...
import ChainKnowledgeBaseDeepdives from '../../../components/Chain/ChainKnowledgeBaseDeepdives/ChainKnowledgeBaseDeepdives';

function PushChainKnowledgeBaseDeepdives() {
  return (
    <Layout
    ...
    >
      ...
      <ChainKnowledgeBaseDeepdives />
    </Layout>
  );
}

export default PushChainKnowledgeBaseDeepdives;
