...
import { Anchor, B, H2, ItemV, Span} from '@site/src/css/SharedStyling';
          ...
          <SliderContainer
            ...
            >
              <SlideElement sendRef={(e) => createPanelsRefs(e,0)} 
                ...
                id={items?.[0]?.content?.metadata.permalink}
                readingTime = {items?.[0]?.content?.metadata.readingTime}
              />
              ...
              <SlideElement sendRef={(e) => createPanelsRefs(e,1)} 
                ...
                id={items?.[1]?.content?.metadata.permalink}
                readingTime = {items?.[1]?.content?.metadata.readingTime}
              />
              ...
              <SlideElement sendRef={(e) => createPanelsRefs(e,2)} 
                ...
                id={items?.[2]?.content?.metadata.permalink}
                readingTime = {items?.[2]?.content?.metadata.readingTime}
              />
