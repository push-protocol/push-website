---
id: dev-chat-develop-send-message
title: Send Message
hide_title: true
slug: ./send-message
...
See <AFocus href='/dev/chat/message-types/'>Message Types</AFocus> to understand how `message` object can be customized to send variety of messages.
...
| -                      | _`message.type`_       | `Text`, `Image`, `File`, `MediaEmbed`, etc      | `Text`  | Type of message, see [Message Types](/dev/chat/message-types) for passing specific parameters based on message type |
