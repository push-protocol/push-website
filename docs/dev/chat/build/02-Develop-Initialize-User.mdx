---
id: dev-chat-develop-initialize-user
...
| -              | `options.version`             | `string`                               | `ENC_TYPE_V3` | The [encryption version](/dev/chat/concepts/encryption-version-in-push-chat) to use for the PushAPI                                          |
