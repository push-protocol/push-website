---
id: docs-spaces-develop-initialize-user
title: Initialize User
hide_title: true
slug: ./initialize-user
displayed_sidebar: pushSpacesSidebar
sidebar_position: 2
image: "/assets/docs/previews/docs_spaces_develop--initialize_user.png"
---

# Initialize user overview

Before you can start using Push Spaces, you will need to initialize a user or re-authenticate the user. To do so you will use `PushAPI.initialize` call from `@pushprotocol/restapi` package.

<head>
  <title>Initialize User | Push Spaces | Push Documentation</title>
</head>
