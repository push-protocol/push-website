...
See <AFocus href='/devs/chat/message-types/'>Message Types</AFocus> to understand how `message` object can be customized to send variety of messages.
...
| -                      | _`message.type`_       | `Text`, `Image`, `File`, `MediaEmbed`, etc      | `Text`  | Type of message, see [Message Types](/devs/chat/message-types) for passing specific parameters based on message type |
