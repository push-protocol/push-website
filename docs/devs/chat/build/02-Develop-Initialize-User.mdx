---
id: devs-chat-develop-initialize-user
...
<Tabs className="codetabs" groupId="code-examples">
  ...
  ```js
    ...
    // pass the signer from your app and set env to 'prod' for mainnet app
...
| -------------- | ----------------------------- | -------------------------------------- | ------------- | -------------------------------------------------------------------------------------- |
| _`signer`_     | _`SignerType`_                | -                                      | -             | EthersV5 or Viem Signer                                                                |
...
| -              | `options.version`             | `string`                               | `ENC_TYPE_V3` | The [encryption version](/devs/chat/concepts/encryption-version-in-push-chat) to use for the PushAPI                                          |
...
> Note: Only parameters _`marked in pink`_ are mandatory.

---

### Initialization Parameters Interface
