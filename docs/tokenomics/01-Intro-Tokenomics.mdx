...
sidebar_position: 1
image: "/assets/docs/previews/docs_tokenomics--intro_to_push_protocol.png"
---

# Intro to Push Protocol

Push uses it's native token - [**_`$PUSH`_**](https://coinmarketcap.com/currencies/epns/ '$PUSH at Coinmarketcap.com') to enable utility, governance, security and to provide incentives for users, crypto wallets and other players in the Push Protocol.
...
{' '}
<ModalSmallEqual flexDirection='column' maxWidth='200px'>
  <MetricTitle>55 Million+</MetricTitle>
  <ModalWrapper>
    <MetricSub>Notifications Sent</MetricSub>
  </ModalWrapper>
</ModalSmallEqual>

{' '}
<ModalSmallEqual flexDirection='column' maxWidth='200px'>
  <MetricTitle>150k+</MetricTitle>
  <ModalWrapper>
    <MetricSub>Subscribers</MetricSub>
  </ModalWrapper>
</ModalSmallEqual>
