---
id: docs-video-supported-wallet-standards
title: Supported Wallet Standards
hide_title: true
slug: ./supported-wallet-standards
displayed_sidebar: pushVideoSidebar
sidebar_position: 2
image: "/assets/docs/previews/docs_video--supported_wallet_standards.png"
---
...
<head>
  <title>Supported Wallet Standards | Push Video | Push Documentation</title>
</head>
...
```typescript
  ...
  const wallet = 'nft:eip155:5:0x42af3147f17239341477113484752D5D3dda997B:2:1683058528';
```
