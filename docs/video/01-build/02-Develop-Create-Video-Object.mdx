---
id: docs-video-develop-create-video-object
title: Create Video Object
hide_title: true
slug: ./create-video-object
displayed_sidebar: pushVideoSidebar
sidebar_position: 2
image: "/assets/docs/previews/docs_video_develop--create_video_object.png"
---
...
<head>
  <title>Create Video Object | Push Video | Push Documentation</title>
</head>
...
<ABlock href="https://www.npmjs.com/package/@pushprotocol/restapi#constructor" title="NPM example of Push Video object contstructor" target="_blank">Video Object Constructor Example</ABlock>