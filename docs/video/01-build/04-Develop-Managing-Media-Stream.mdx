...
<ABlock
  href="https://www.npmjs.com/package/@pushprotocol/restapi#enablevideo"
  title="NPM example of Push Video Enable Video API"
  target="_blank"
>
  Enable Video API Example
</ABlock>

<ABlock
  href="https://www.npmjs.com/package/@pushprotocol/restapi#enableaudio"
  title="NPM example of Push Video Enable Audio API"
  target="_blank"
>
  Enable Audio API Example
</ABlock>
