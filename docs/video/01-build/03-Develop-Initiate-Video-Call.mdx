...
<ABlock
  href="https://www.npmjs.com/package/@pushprotocol/restapi#create"
  title="NPM example of Push Video Create API"
  target="_blank"
>
  Create API Example
</ABlock>
...
| Property         | Description                                                                                             |
| ---------------- | ------------------------------------------------------------------------------------------------------- |
| senderAddress    | Wallet address of the local user                                                                   |
| recipientAddress | Wallet addresses of users you want to call, single address for wallet to wallet call and array of addresses for group call |
...
| Property         | Description                                                                                             |
| ---------------- | ------------------------------------------------------------------------------------------------------- |
| recipientAddress | Wallet address of remote user ie the address which you want to call                                |
| senderAddress    | Wallet address of the local user                                                                   |
| chatId           | Unique identifier for every push chat, here, the one between the senderAddress and the recipientAddress |
...
| senderAddress    | Wallet address of the local user                                                                   |
| recipientAddress | Wallet address of the remote user, i.e., the address whose call request you want to accept         |
| chatId           | Unique identifier for every push chat, here, the one between the senderAddress and the recipientAddress |
| onReceiveMessage | Function which will be called when the sender receives a message via webRTC data channel                |
...
| peerAddress | The address you want connect the call with, defaults to `data.incoming[0].address` |
...
| Property   | Description                                                                                 |
| ---------- | ------------------------------------------------------------------------------------------- |
| peerAddress | The address you want disconnect the call with, defaults to `data.incoming[0].address` |
