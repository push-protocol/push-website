...
| -------------- | ----------------------------------- | -------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| _`recipients`_ | `string[]`                          | -        | Wallet address or addresses of the recipient(s). Number of different [wallet standards](/docs/chat/supported-wallet-standards 'Push Chat support wallet standards') are supported. |
