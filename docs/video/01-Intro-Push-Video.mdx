...
Push Video utilizes [Push Notifications](/docs/notifications) to exchange peer info and intent for connection which is then fed into [WebRCT](https://webrtc.org/ "Learn about WebRCT") for peer to peer connection. 
