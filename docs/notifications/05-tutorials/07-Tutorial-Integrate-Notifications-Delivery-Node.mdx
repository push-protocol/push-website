...
The whitelabel solution of Push delivery node [is located in this github repo](https://github.com/push-protocol/push-delivery-node "Repo of delivery node of Push protocol"). Below are the steps for getting started —
