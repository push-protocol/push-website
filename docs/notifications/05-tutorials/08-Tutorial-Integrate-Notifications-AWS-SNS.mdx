...
For your reference, here's [Push AWS SNS boilerplate](https://github.com/push-protocol/push-website/push-sns-boilerplate "Push AWS SNS boilerplate") which can be used as a starting point to consume the feeds from the Push SNS Topic.
