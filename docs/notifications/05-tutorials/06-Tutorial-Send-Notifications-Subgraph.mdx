...
Here is the [final Subgraph with Push integration](https://github.com/push-protocol/push-website/push-sdk/tree/main/packages/examples/subgraph-notification "Example of subgraph that has Push notifications enabled").
