...
<head>
  <title>Testing Notifications | Push Notifications | Push Documentation</title>
</head>
...
function App(props) {
  const [wallet, setWallet] = useState('0xD8634C39BBFd4033c0d3289C4515275102423681');
  ...
  const fetchNotification = async () => {
    ...
    const inboxNotifications = await userAlice.notification.list('INBOX', {account: `eip155:5:${wallet}`, limit: 5})
