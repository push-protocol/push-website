---
id: docs-notifications-develop-integrating-widgetuiprovider
title: WidgetUIProvider
hide_title: true
slug: ./integrating-widgetuiprovider
...
| `theme`         | `IWidgetTheme`      | -       | [Theme object](/docs/notifications/build/widget-themization/), it can be custom theme object, `lightWidgetTheme` `darkWidgetTheme` |
