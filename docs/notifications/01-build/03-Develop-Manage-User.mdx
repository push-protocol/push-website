...
<head>
  <title>{`Manage User | Push Notifications | Push Documentation`}</title>
</head>
...
:::tip
Attaching progress hook functionality in [Initialize user API](/docs/notifications/build/initialize-user) will help you to track the progress of encryption update.
:::
