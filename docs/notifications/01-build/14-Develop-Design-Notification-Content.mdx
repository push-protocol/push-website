...
We believe notifications or any sort of web3 communication is a community wide effort and we invite everyone to come, discuss and better it for everyone via [Push Improvement Proposals (PIPs)](https://github.com/push-protocol/push-website/PIPs "Learn more about Push Improvement Proposals (PIPs)").
