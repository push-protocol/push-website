...
| -          | `options.account`        | `string`                               | -             | The [account](/docs/notifications/supported-wallet-standards 'Push Notifications support wallet standards') to associate user with. If not provided, it is derived from signer. |
