...
- Boolean Setting - This setting allows users to set their preference as true / false. **For example:** _receive marketing notifications_
- Slider Setting - This setting allows users to set their preference between a slider. **For example:** _alert when ENS domain expires (Between 1 - 7 days)_
