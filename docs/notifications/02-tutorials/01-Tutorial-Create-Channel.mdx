...
sidebar_position: 1
image: "/static/assets/docs/previews/docs_notifications_tutorial_create_channel--creating_your_channel.png"
---
...
- Get Goerli ETH from [Paradigm Faucet](https://faucet.paradigm.xyz)
- Get Goerli ETH by joining [Push Discord](https://discord.gg/pushprotocol) > Asking in **#brb-goerli-eth-faucet** discord channel
- Get Goerli PUSH from [Push Testnet Contract](https://goerli.etherscan.io/address/0x2b9bE9259a4F5Ba6344c1b1c07911539642a2D33)
