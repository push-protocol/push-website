...
sidebar_position: 6
image: "/static/assets/docs/previews/docs_notifications_tutorials_push_react_component_playground_example--push_sdk_react_playground.png"
---
...
<head>
  <title>
    Push SDK React playground tutorial | Push Notifcation | Push Documentation
  </title>
</head>
...
<img src={require('/docs/assets/sdk-react-playground.png').default} />
