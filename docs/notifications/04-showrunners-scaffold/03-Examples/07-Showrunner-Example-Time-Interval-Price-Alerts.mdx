...
We will choose the [Eth Tracker](https://github.com/push-protocol/push-website/push-showrunners-channels/tree/wallet-tracker/Staging_channels/ethTicker "Push Channel Eth Tracker") channel to demonstrate this example.
...
#### [Channel File](https://github.com/push-protocol/push-website/push-showrunners-framework/blob/main/src/sample_showrunners/bank/bankChannel.ts "Eth Tracker Channel Github")
...
To fetch a list of all users who have opted into receiving notifications along with their opted value from `userAlice`, you can use the `subscribers` method. You can read about this method in detail [here](https://push.org/docs/notifications/build/manage-subscriptions/ "Channel Settings Docs").
...
The returned data will look something like this⬇️
