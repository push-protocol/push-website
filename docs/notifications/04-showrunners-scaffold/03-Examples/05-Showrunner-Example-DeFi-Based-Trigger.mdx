...
You can access the [code](https://github.com/push-protocol/push-website/push-showrunners-framework-staging/tree/main/src/sample_showrunners/aave) for the channel and get some vibe for how the code is looking !!
