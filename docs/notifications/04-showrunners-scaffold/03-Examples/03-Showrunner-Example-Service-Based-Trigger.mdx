...
You can access the [code](https://github.com/push-protocol/push-website/push-showrunners-framework-staging/tree/main/src/sample_showrunners/ens) for the channel and get some vibe for how the code is looking !!
...
#### [Channel File](https://github.com/push-protocol/push-website/push-showrunners-framework/blob/main/src/sample_showrunners/ens/ensChannel.ts)
...
#### [Jobs File](https://github.com/push-protocol/push-website/push-showrunners-framework/blob/main/src/sample_showrunners/ens/ensJobs.ts)
...
The local [settings ](https://github.com/push-protocol/push-website/epns-showrunners-framework-staging/blob/main/src/sample_showrunners/ens/ensSettings.json)file also play an influential in the code flow for reference you can have a look into that too.
