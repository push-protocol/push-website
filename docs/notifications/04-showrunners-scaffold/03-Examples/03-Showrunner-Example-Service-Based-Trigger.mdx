...
The local [settings ](https://github.com/push-protocol/epns-showrunners-framework-staging/blob/main/src/sample_showrunners/ens/ensSettings.json)file also play an influential in the code flow for reference you can have a look into that too.
