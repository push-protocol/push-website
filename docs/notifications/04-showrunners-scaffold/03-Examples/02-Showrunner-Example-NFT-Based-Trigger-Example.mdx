...
You can access the [code](https://github.com/push-protocol/push-website/push-showrunners-framework-staging/tree/main/src/sample_showrunners/digible) for the channel and get some vibe for how the code is looking !!
...
#### [Channel File](https://github.com/push-protocol/push-website/push-showrunners-framework/blob/main/src/sample_showrunners/digible/digibleChannel.ts)
...
#### [Jobs File](https://github.com/push-protocol/push-website/push-showrunners-framework/blob/main/src/sample_showrunners/digible/digibleJobs.ts)
