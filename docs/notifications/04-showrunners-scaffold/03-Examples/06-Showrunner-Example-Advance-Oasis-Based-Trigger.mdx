...
#### Adding [contarctAddress.json](https://github.com/push-protocol/push-website/epns-showrunners-framework/blob/main/src/showrunners/oasis/contractAddress.json) file
...
#### Adding [oasisChannel.ts](https://github.com/push-protocol/push-website/epns-showrunners-framework/blob/main/src/showrunners/oasis/oasisChannel.ts) file
...
#### Adding [oasisJobs.ts](https://github.com/push-protocol/push-website/epns-showrunners-framework/blob/main/src/showrunners/oasis/oasisJobs.ts) file
...
#### Adding [oasisRoutes.ts](https://github.com/push-protocol/push-website/epns-showrunners-framework/blob/main/src/showrunners/oasis/oasisRoutes.ts) file
