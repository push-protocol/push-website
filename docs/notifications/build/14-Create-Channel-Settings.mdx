---
id: docs-notifications-develop-create-channel-setting
title: Create Channel Settings
hide_title: true
...
<head>
  <title>Create Channel Setting | Push Notifications | Push Documentation</title>
</head>
