...
| -           | `options.alias`         | `string`                  | -       | alias address in in [chain specific wallet format](/docs/notifications/build/important-concepts/#chain-specific-wallet-address) |
| -           | `options.progresshook`  | `(progress) => void`      | -       | A callback function that's called during channel creation progress, [see progress object](/docs/notifications/build/create-channel/#progress-object-parameters) |
