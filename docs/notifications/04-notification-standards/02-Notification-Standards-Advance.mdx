...
### Understanding Verification Proofs
...
### Verification Proofs Example - Transaction Based (eip155:....)
...
### Verification Proofs Example - EIP-712
...
**2. EIP-712v2 - eip712v2:Proof** Contains a payload that is future compatible. It means the payload can be dynamic and can be extended for future reference.