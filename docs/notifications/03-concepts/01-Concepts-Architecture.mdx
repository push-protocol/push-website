...
sidebar_position: 1
image: "/static/assets/docs/previews/docs_notifications_concepts_architecture_overview--push_notification_architecture.png"
---
...
<head>
  <title>Architecture Overview | Push Notifications | Push Documentation</title>
</head>
