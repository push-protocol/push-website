...
You can access the [code](https://github.com/ethereum-push-notification-service/push-showrunners-framework-staging/tree/main/src/sample_showrunners/digible) for the channel and get some vibe for how the code is looking !!

<head>
  <title>NFT based trigger | Example | Showrunners Scaffold | Push Notifications |
...
#### [Channel File](https://github.com/ethereum-push-notification-service/push-showrunners-framework/blob/main/src/sample_showrunners/digible/digibleChannel.ts)
...
#### [Jobs File](https://github.com/ethereum-push-notification-service/push-showrunners-framework/blob/main/src/sample_showrunners/digible/digibleJobs.ts)
