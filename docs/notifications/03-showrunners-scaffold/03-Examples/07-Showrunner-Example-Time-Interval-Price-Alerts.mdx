...
We will choose the [Eth Tracker](https://github.com/ethereum-push-notification-service/push-showrunners-channels/tree/wallet-tracker/Staging_channels/ethTicker "Push Channel Eth Tracker") channel to demonstrate this example.
...
#### [Channel File](https://github.com/ethereum-push-notification-service/push-showrunners-framework/blob/main/src/sample_showrunners/bank/bankChannel.ts "Eth Tracker Channel Github")
