...
# NFT transfer trigger via showrunner scaffold
...
<Head>
  <title>NFT transfer trigger | Example | Showrunners Scaffold | Push Notifications |
...
```js
const events = await coven.contract.queryFilter(
  filter,
