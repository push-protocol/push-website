...
:::note
Ensure you have read [get started guide](/docs/notifications/showrunners/ "Guide for getting started with Showrunners scaffold for trigger notificatons via Push protocol") for Showrunners scaffold before diving in specifics of this guide as the guide relies on terminologies used over there.
:::
