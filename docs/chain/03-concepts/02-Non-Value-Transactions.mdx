...
## **What Are Non-Value Transfers?**

Non-value transfers refer to blockchain transactions that do not involve the transfer of financial assets, such as cryptocurrencies or tokens. Instead, these transactions facilitate the exchange of **data**. Examples include:
...
### **3. Session Keys for Streamlined UX**
Non-value transactions often require frequent interactions, such as sending notifications or retrieving updates. Push Chain introduces **session keys** to enhance usability:
- Users can delegate limited access to dApps without exposing their private keys.
- Session keys reduce the need for repeated user approvals, offering a smooth and frictionless experience.

---

### **4. Affordable and Scalable Transactions**
...
The ability to handle non-value transactions at scale opens up new possibilities for consumer-facing dApps. Here are a few examples:
...
Emails can be securely sent between users on different chains using Push Chain. Stateless blocks ensure that these communications are fast, affordable, and privacy-focused.
