...
### **1. Stateless Blocks**
Push Chain introduces stateless blocks to handle non-value transactions efficiently. These transactions, such as notifications and emails, do not require state modifications, allowing for increased parallelism and scalability.
...
### **4. Session Keys**
To improve UX, Push Chain supports session keys, allowing users to delegate temporary permissions to applications without compromising security.

### **5. Non-Value Transfers**
