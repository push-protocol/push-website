---
id: docs-chain-build-get-started
title: Get Started
hide_title: true
slug: ./get-started
...
import SandboxIDE from '@site/src/components/SandboxIDE/SandboxIDE';

## Speed run

<SandboxIDE files={{
  '/index.js': `// Import only what we need from ethers to avoid native dependencies
const { HDNodeWallet, Wallet, verifyMessage, parseEther, formatEther } = require('ethers');
