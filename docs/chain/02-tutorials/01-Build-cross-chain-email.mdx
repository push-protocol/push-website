...
import EasterEggImg from '@site/static/assets/docs/eggs/Easter-Egg-7.png';
...
This tutorial demonstrated how to build a cross-chain email system using the Push Chain SDK, enabling seamless communication between blockchains like Ethereum and Solana. By setting up the SDK, configuring accounts, and signing transactions, you’ve learned how to send and fetch messages securely across chains. <EasterEgg src={EasterEggImg} />
