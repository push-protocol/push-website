...
| **Arguments** | **Type** | **Description**                                      |
| ------------- | -------- | ---------------------------------------------------- |
| _`chainId`_   | `number` | The chain ID to convert to chain name. Eg: `eip155:42101` converts to `PUSH_CHAIN_TESTNET_DONUT`, `eip155:11155111` converts to `ETHEREUM_SEPOLIA`             |
