...
{`
    ...
    // customPropHighlightRegex=PushChain\.utils\.signer\.toUniversal
...
{`
    ...
    // customPropHighlightRegex=PushChain\.utils\.signer\.toUniversalFromKeyPair
    // Import Push Chain Core
    import { PushChain } from '@pushchain/core';
...
`}
  ...
  [UI Kit / UI Components](/docs/chain/ui-components/) abstracts away creation of the Universal Signer for you.
