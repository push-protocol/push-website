...
**_`await PushChain.utils.signer.toUniversal(signer)`_**
...
{`
    ...
    async function main() {
      ...
      console.log('Created Universal Signer with custom signing functions', JSON.stringify(universalSignerSkeleton, null, 2), '\n--\n\n');
...
### Custom Universal Signer Parameters

**_`await PushChain.utils.signer.construct(account, {options})`_**
