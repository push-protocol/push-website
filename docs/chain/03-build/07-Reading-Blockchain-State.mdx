...
{`
    // customPropHighlightRegexStart=ethers\.WebSocketProvider
    // customPropHighlightRegexEnd=}\\);
    import { ethers } from 'ethers';
...
## Next Steps
- Dive into our [Contract Helpers](./contract-helpers) to detect and work with both cross-chain accounts and native Push Chain smart accounts.
