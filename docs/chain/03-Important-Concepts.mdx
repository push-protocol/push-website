...
- `chain`: A fully qualified chain identifier that combines both the blockchain type and specific network (e.g., `CHAIN.ETHEREUM_SEPOLIA`, `CHAIN.SOLANA_DEVNET`, `CHAIN.PUSH_TESTNET`)
...
- `chain`: A fully qualified chain identifier (e.g., `CHAIN.ETHEREUM_SEPOLIA`, `CHAIN.SOLANA_DEVNET`, `CHAIN.PUSH_TESTNET`)
