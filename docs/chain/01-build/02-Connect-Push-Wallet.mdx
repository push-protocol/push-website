...
import EasterEggImg from '@site/static/assets/docs/eggs/Easter-Egg-6.png';
...
Push Chain introduces email-based login, bridging the gap between Web2 and Web3. This feature enables new users to easily onboard without needing prior blockchain knowledge while ensuring secure interactions. <EasterEgg src={EasterEggImg} />
