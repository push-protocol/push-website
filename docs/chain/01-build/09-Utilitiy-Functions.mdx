...
### 2.1 Create UniversalSigner from Viem Wallet
...
### `toUniversalFromViem` parameters

| **Param**     | **Type**                | **Remarks**                                                                                       |
|---------------|-------------------------|---------------------------------------------------------------------------------------------------|
| `account`  | `Account`   | A viem Account instance (e.g., from privateKeyToAccount). |
| `chain`  | `CHAIN`   | The target chain for the signer. |
...
### 2.2 Create UniversalSigner from Solana Keypair
...
### `toUniversalFromSolanaKeypair` parameters

| **Param**     | **Type**                | **Remarks**                                                                                       |
|---------------|-------------------------|---------------------------------------------------------------------------------------------------|
| `keypair`  | `Keypair`   | A Solana Keypair instance. |
| `chain`  | `CHAIN`   | The target chain for the signer. |
...
```typescript
{
  chain: CONSTANTS.CHAIN.SOLANA_DEVNET,
...
|---------------------------|--------------------------|-----------------------------------------------------------------------------------------------------|
| `chain`             | `CHAIN`                | The chain identifier |
| `address`             | `string`                | The signer's Solana address (base58) |
| `signMessage`             | `function`                | Function to sign arbitrary messages |
| `signTransaction`             | `function`                | Function to sign transactions |
