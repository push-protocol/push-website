...
1. **Account/Address Conversion** (CAIP-10 ↔ UniversalAccount)
...
<Tabs className="codetabs" groupId="code-examples">
  ...
  ```typescript
  const universalAccount = PushChain.utils.account.fromChainAgnostic(chainAgnosticAddress)
  ```
  </TabItem>
</Tabs>
...
```typescript
const universalAccount = PushChain.utils.account.fromChainAgnostic('eip155:11155111:0x35B84d6848D16415177c64D64504663b998A6ab4');
...
| `options.chain`  | `CHAIN`   | The target chain for the signer. Here are some possible values: `CONSTANTS.CHAIN.ETHEREUM_MAINNET`, `CONSTANTS.CHAIN.ETHEREUM_SEPOLIA`, `CONSTANTS.CHAIN.SOLANA_MAINNET` |


#### Example: Convert Ethereum Sepolia Address to UniversalAccount

```typescript
const universalAccount = PushChain.utils.account.toUniversal('0x35B84d6848D16415177c64D64504663b998A6ab4', {
  chain: CONSTANTS.CHAIN.ETHEREUM_SEPOLIA,
});
console.log(universalAccount);
// {
...
```typescript
const chainAgnosticStr = PushChain.utils.account.toChainAgnostic('0xabc123...', {
