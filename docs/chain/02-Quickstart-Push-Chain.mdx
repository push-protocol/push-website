...
console.log(
  'Origin address is only present if other chains address is connected to Push Chain Client'
);
...
- Plug in wallet UI via [UI Components](../02-ui-components/01-Integrate-Push-Universal-Wallet)
- Try a full-app walkthrough in [Tutorials](../03-tutorials)
- For deep dives visit our [Knowledge Base](/knowledge)
