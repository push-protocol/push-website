...
GM vs GM is a simple example to show how to create a Universal App on Push Chain that is accessible from any chain and wallet. We will create a simple counter app that can be incremented from any chain and wallet and that tracks the overall count and individual counts for each chain.

## Creating Smart Contract

We take a simple counter smart contract and deploy it on Push Chain.
