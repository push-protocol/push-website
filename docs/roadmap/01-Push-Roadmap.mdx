...
Push Protocol amd Nodes is evolving, we will be announcing the evolution of this milestone soon via governance.
...
V2 is changed to be an iterative process to avoid breaking changes and instead work on backward compatible features. The iterations can be tracked [here](https://github.com/push-protocol/push-sdk).
...
### Hyper Scalable Chat <sup>_NEW_</sup> _**<sup><sub>Q1 2024[↗](/blog/benchmarking-push-chat-message/ 'Scaling Push Chat Benchmarking')</sub></sup>**_
...
Push has sent over 140m notifications and has more than 300k subscribers getting notifications to wallets. We will be enabling protocols to send notifications to email and telegram in addition to Push notifications to wallets to further simplify the UX and to expand the reach of Push to mainstream users.
