...
Groups can be gated based on a number of conditions such as token gating, NFT gating, or Guild gating. Learn more about [conditional rules for group](/docs/chat/build/conditional-rules-for-group) to understand how to fine tune conditional rules of your group.
