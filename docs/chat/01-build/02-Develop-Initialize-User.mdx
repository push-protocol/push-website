...
Push Chat supports Lens, Cyberconnect, NFT wallets and any EVM or non-EVM wallets ensuring cross-chain messaging or cross-nft messaging can become a reality.

To use Push Chat for Lens, Cyberconnect, NFT wallets or any EVM or non-EVM wallets, you will need to pass the `account` parameter in `options` object while initializing. This will ensure that the PushAPI is initialized for the right account. 
...
| ---------- | ------------------------ | -------------------------------------- | ------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| _`signer`_ | `SignerType`             | -                                      | -             | Ethers or Viem Signer.                                                                                                                                                              |
