...
Head to our app and [talk to PushAI](https://app.push.org/chat/pushai.eth) which stands for **Prioritize Using Silly Humor And Irony**. It's addictive and you have been warned!
...
- [Push SDK Playground](https://github.com/push-protocol/push-website/push-sdk/blob/main/packages/examples/sdk-backend-node/chat/chat.ts) to checkout abstracted API calls in action. Follow <AImp href={'/docs/chat/playground/push-sdk-playground'}>Push SDK playground tutorial</AImp> for step by step guide.
- [React Components Example](https://github.com/push-protocol/push-website/push-sdk/tree/main/packages/examples/sdk-frontend-react) to checkout frontend components of Push Chat for easy integration in any React app. Follow <AImp href={'/docs/chat/playground/push-react-component-playground-example'}>Push SDK React playground</AImp> for step by step guide.
