...
<Details summary="Expected response (CONSTANTS.STREAM.CHAT - Chat Request Stream)">
...
<Details summary="Expected response (CONSTANTS.STREAM.CHAT - Chat accept stream)">
...
<Details summary="Expected response (CONSTANTS.STREAM.CHAT - Chat message stream)">
...
<Details summary="Expected response (CONSTANTS.STREAM.CHAT - Chat rejection stream)">
...
<Details summary="Expected response (CONSTANTS.STREAM.CHAT - Group chat message stream)">
...
<Details summary="Expected response (CONSTANTS.STREAM.CHAT - Group chat request stream)">
...
<Details summary="Expected response (CONSTANTS.STREAM.CHAT - Group chat request accepted stream)">
...
<Details summary="Expected response (CONSTANTS.STREAM.CHAT - Group chat request rejected stream)">
...
<Details summary="Expected response (CONSTANTS.STREAM.CHAT - Participant removed from group stream)">
...
<Details summary="Expected response (CONSTANTS.STREAM.CHAT - Participant joins a group stream)">
...
<Details summary="Expected response (CONSTANTS.STREAM.CHAT - Participant leaves a group stream)">
...
<Details summary="Expected response (CONSTANTS.STREAM.CHAT_OPS - Group created stream)">
...
<Details summary="Expected response (CONSTANTS.STREAM.CHAT_OPS - Group updated stream)">
...
## Reinstate chat stream

To reinstate a chat stream. Useful when you want to listen to more events or change the filter options.

<Tabs className="codetabs" groupId="code-examples">
  <TabItem value="js" attributes={{className: "codetab js"}} default>

```typescript
// say you created a stream like this, const stream = await userAlice.initStream( [ 'STREAM.NOTIF', 'STREAM.CONNECT', 'STREAM.DISCONNECT' ]);
// now you want to listen to more events or change the filter options
// then you can do that using this method
...
```typescript
// say you created a stream like above, const stream = await userAlice.initStream( [ 'STREAM.CHAT', 'STREAM.CONNECT', 'STREAM.DISCONNECT' ]);
// then you can get the info of the stream like this
