---
id: docs-chat-develop-manage-chat
title: Manage Chat
hide_title: true
slug: ./manage-chat
displayed_sidebar: pushChatSidebar
sidebar_position: 4
image: "/assets/docs/previews/docs_chat_develop--manage_chat.png"
---
...
```typescript
{
  ...
  list: 'CHATS',
  participants: [
    'eip155:0x68580b23781547969de5033e39470D2039a9938e',
    'eip155:0xb44a29524433dBC639C35124459c741bC241d4f4'
  ],
  chatId: '66f23e09c14f221c6d370ad2d8f38f2629acedbd7a7b4d1fd0490437e8f1e43d',
  recipient: '0x68580b23781547969de5033e39470D2039a9938e'
}
...
| ------------ | --------- | ----------------------------------------------------------------------------- |
| `meta.group` | `boolean` | returns `true` when the passed chatId is of a group chat and vice versa.      |
| `list`       | `string`  | returns `REQUESTS` when the chat request is pending and not yet accepted. |
