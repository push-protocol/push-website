...
const userAlice = await PushAPI.initialize(signer, {
  ...
  // if you want to have stored the user's decryptedPGPPrivateKey, you can pass it here to avoid asking the user to sign the message to initialise Push API everytime
