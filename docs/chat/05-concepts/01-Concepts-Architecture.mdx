...
sidebar_position: 1
image: "/static/assets/docs/previews/docs_chat_concepts_architecture_overview--push_chat_architecture.png"
---
...
<head>
  <title>Architecture Overview | Push Chat | Push Documentation</title>
</head>

import CustomLinkCard from '@site/src/components/CustomLinkCard';
import {ItemV, ItemH, Span, Button, Image, ModalContainer, ModalItemSmall, ModalItemSmallColumn, AImp } from '@site/src/css/SharedStyling';
