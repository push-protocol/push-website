...
See <AImp href='/chat/message-types/'>Message Types</AImp> to understand how `message` object can be customized to send variety of messages.
...
See <AImp href='/docs/chat/message-types/'>Message Types</AImp> to understand how `message` object can be customized to send variety of messages.
