...
The ChatViewBubble is a robust component that automatically embeds Push Frames, supporting both the Open Frames Specification and Farcaster Frames Spec right out of the box. By using the ChatViewBubble Component, your client/app will be fully compatible with any Frames.

When a message contains a web link, the ChatViewBubble Component identifies it and verifies whether it's a media or frames URL. If valid, it embeds the media or frames directly into the chat bubble. When the URL is a frames URL, it automatically renders the frames in the chat bubble, making them easily interactable by your users from within your client/app.
...
const ChatViewBubbleTest = () => {
  const msg = {
    ...
    messageObj: {
      content: "lets play a game https://cyo-adventure.vercel.app/",
    },
    messageContent: "lets play a game https://cyo-adventure.vercel.app/",
    messageType: "Text",
...
<ModalContainer>
  ...
  <img
    src={
      require('/static/assets/docs/chat/ui-components/advanced/integrate-advanced-chatviewbubble-component/chatViewBubbleWithFrames.png')
        .default
    }
  />
</ModalContainer>
