...
<head>
  <title>ChatViewBubble | UI Components (@pushprotocol/uiweb) | Push Chat | Push Documentation</title>
</head>
...
<Tabs className="codetabs" groupId="code-examples">
  ...
  <ModalContainer>
    <img src={require("/static/assets/docs/chat/ui-components/advanced/integrate-advanced-chatviewbubble-component/chat-view-bubble.png").default} />
  </ModalContainer>
...
### Push ChatViewBubble Component live playground
```jsx live 
...
function App(props) {
  ...
  return (
    <>
      <h2>Change the msg object in the Live editor to test different types of messages</h2>
        <ChatUIProvider>
           <ChatViewBubble decryptedMessagePayload={msg} />
        </ChatUIProvider>
    </>
