...
<Tabs className="codetabs" groupId="code-examples">
  ...
  <ModalContainer>
    <img src={require("/static/assets/docs/chat/ui-components/advanced/integrate-advanced-chatviewlist-component/chat-view-list.png").default} />
  </ModalContainer>
...
### Push ChatViewList Component live playground
```jsx live
    ...
    <>
      <h2>Interact with ChatViewList by changing the chatId.</h2>
        <ChatUIProvider signer={signer}>
         ...
         Connect wallet for better usage of the ChatViewList component.
         </label>
      
      <p/>
      <button style={buttonStyle} onClick={signer ? disconnectWallet : connectWallet}>{signer ? "Disconnect wallet" : "Connect Wallet"}</button>

          <div style={{ height: '75vh', margin: '20px auto' ,overflow:'hidden scroll' }}>
