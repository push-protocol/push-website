...
<Tabs className="codetabs" groupId="code-examples">
  ...
  <ModalContainer>
    <img src={require("/static/assets/docs/chat/ui-components/advanced/integrate-advanced-chatprofile-component/chat-profile.png").default} />
  </ModalContainer>
...
### Push ChatProfile Component live playground
```jsx live 
  ...
  return (
    <>
      <h2>Interact with ChatProfile by changing the chatId.</h2>
        <ChatUIProvider >
          <ChatProfile chatId="0x99A08ac6254dcf7ccc37CeC662aeba8eFA666666" style='Info' />
        </ChatUIProvider>
    </>
  );
}
