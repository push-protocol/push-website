...
<head>
  <title>ChatPreview | UI Components (@pushprotocol/uiweb) | Push Chat | Push
    Documentation</title>
</head>
...
const chatPreviewPayloadData =  {
  ...
  return (
    <>
      <h2>
        Change the chatPreviewPayloadData object in the Live editor to test different types of
        messages
      </h2>
      <ChatUIProvider>
        <ChatPreview 
