...
<Tabs className="codetabs" groupId="code-examples">
  ...
  <Chat
    account="0x6430C47973FA053fc8F055e7935EC6C2271D5174" //user address - this belongs to the user
...
function App(props) {
  ...
  return (
    <>
      ...
      <label>For this demo, You will need Metamask (or equivalent browser injected wallet), you will also need to sign a transaction to see the notifications.</label>
      ...
      <div style={{ margin: '20px auto' }}>
        ...
        {signer && 
          <>
            ...
            <h2>Signer obtained, you will be seeing a pink colored Push Chat icon on the bottom right, click to interact.</h2>
          </>
        }
      </div>
    </>
