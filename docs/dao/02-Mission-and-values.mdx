---
id: docs-dao-mission-and-values
title: Mission and Values
hide_title: false
slug: ./mission
displayed_sidebar: pushDaoSidebar
sidebar_position: 2
image: '/assets/docs/previews/docs_dao--mission_and_values.png'
---
...
Push DAO is in a progressive decentralization process towards becoming a community-governed, decentralized autonomous organization (DAO) that promotes the ecosystem growth and shapes the future of Push Protocol – open-source infrastructure enabling cross-chain infrastructure for building the communication network for Web3.
